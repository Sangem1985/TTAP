<%@ Page Title="" Language="C#" MasterPageFile="~/UI/UserMaster.Master" AutoEventWireup="true" CodeBehind="frmGenerateAgendaList.aspx.cs" Inherits="TTAP.UI.Pages.DLC.frmGenerateAgendaList" %>
                ...
                <div id="content-header">
                    ...
                    <div class="breadcrumb-bg">
                        <ul class="breadcrumb font-medium title5 container">
                            ...
                            <li class="breadcrumb-item">Generate DLC Agenda</li>
                        </ul>
                    </div>
                </div>
                                ...
                                <div class="widget-content nopadding">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 text-center" id="tblselection" runat="server">
                                            <asp:Button ID="btnGenerateProposedAgenda" CssClass="btn btn-primary m-2" runat="server" Text="Generate Proposed DLC Agenda" OnClick="btnGenerateProposedAgenda_Click" />
