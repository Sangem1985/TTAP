...
{
    public partial class frmGenerateAgendaList : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ds = ObjCAFClass.GetDLCYetGenerateAgendaList(Cast, Investmentid, distid, Status);
        ...
        protected void btnGenerateProposedAgenda_Click(object sender, EventArgs e)
        {
            ...
            valid = ObjCAFClass.GenerateDLCProposedAgenda(lstApplicationStatus);
            if (valid == "1")
            {
                btnGenerateProposedAgenda.Enabled = false;
                string message = "alert('Proposed DLC Agenda Generated Successfully')";
                ScriptManager.RegisterClientScriptBlock((sender as Control), this.GetType(), "alert", message, true);
