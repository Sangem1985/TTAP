<%@ Page Title="" Language="C#" MasterPageFile="~/UI/UserMaster.Master" AutoEventWireup="true" CodeBehind="frmGeneratedAgendaUpdate.aspx.cs" Inherits="TTAP.UI.Pages.DLC.frmGeneratedAgendaUpdate" %>
                ...
                <div id="content-header">
                    ...
                    <div class="breadcrumb-bg">
                        <ul class="breadcrumb font-medium title5 container">
                            ...
                            <li class="breadcrumb-item">Generated DLC Agenda</li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="w-100 px-3 frm-form box-content py-3 font-medium title5">
                            <div class="widget-box">
                                ...
                                <div class="widget-content nopadding">
                                        ...
                                        <div class="col-sm-12 table-responsive">
                                            <asp:GridView ID="gvdetailsnew" runat="server" AllowPaging="false" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="SLCDLCRecommended_date" ItemStyle-HorizontalAlign="Center" HeaderText="DLO Recommended Date TO DLSVC">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="ActualRecommendedAmount" ItemStyle-HorizontalAlign="Center" HeaderText="DLO Recommended Amount TO DLSVC">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="SVC_FinalSanctionedAmount" ItemStyle-HorizontalAlign="Center" HeaderText="DLSVC Recommended Amount TO DLC">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="SVC_Sanctioned_Date" ItemStyle-HorizontalAlign="Center" HeaderText="DLSVC Recommended Date TO DLC">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 text-blue font-SemiBold mb-1">DLC Proceedings to be uploaded</div>
                                        <div class="col-sm-12 table-responsive">
                                            <table class="table table-bordered title6 alternet-table w-100 NewEnterprise">
                                                ...
                                                <tr class="GridviewScrollC1Item" id="trDocrent" runat="server">
                                                    ...
                                                    <td align="left" style="width: 50%">DLC Proceedings</td>
                                                    <td align="left">
