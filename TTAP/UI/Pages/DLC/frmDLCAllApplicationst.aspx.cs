...
{
    public partial class frmDLCAllApplicationst : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                ds = ObjCAFClass.GenericFillDs("USP_GET_ABSTRACT_DLC_APPROVED_LIST", pp);  //USP_GET_UNIT_INCENTIVEWISE_DIPC_NEW_ONLINEAPPS
