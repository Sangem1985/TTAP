...
{
    public partial class frmDLCSactionedApplications : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.Redirect("frmDLCAllApplicationst.aspx?Cast=" + lblCategory1 + "&MstIncentiveId=" + lblMstIncentiveId + "&SubIncId=" + lblSubIncType +
        ...
        public void getallapproveddipcno()
        {
            ...
            pp[0].Value = Distid;
            ds = ObjCAFClass.GenericFillDs("USP_GET_LIST_INCENTIVE_DIPCSanctionNO", pp);
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            ds = ObjCAFClass.GenericFillDs("USP_GET_ABSTRACT_DLC_APPROVED", pp); 
