<%@ Page Title="" Language="C#" MasterPageFile="~/UI/UserMaster.Master" AutoEventWireup="true" CodeBehind="frmDLCAllApplicationst.aspx.cs" Inherits="TTAP.UI.Pages.DLC.frmDLCAllApplicationst" %>
                                ...
                                <div class="widget-content nopadding">
                                    <div class="row" id="divPrint" runat="server">
                                        ...
                                        <div class="row col-sm-12">
                                            ...
                                            <div class="col-sm-6 col-md-3 form-group">
                                                <label runat="server" id="td1">DLC No</label>
                                        ...
                                        <div class="col-sm-12 table-responsive">
                                            <asp:GridView ID="gvdetailsnew" runat="server" AllowPaging="false" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="Meeting_No" ItemStyle-HorizontalAlign="Center" HeaderText="DLC Meeting No">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="Actual_Meeting_Date" ItemStyle-HorizontalAlign="Center" HeaderText="DLC Meeting Date">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
