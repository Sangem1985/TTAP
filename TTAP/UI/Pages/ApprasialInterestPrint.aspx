                ...
                <div>
                    <div>
                        ...
                        <table bgcolor="White" width="100%" style="font-family: Verdana; font-size: small;">
                            ...
                            <tr>
                                <td style="width: 2%"></td>
                                <td class="auto-style1">7. Udyam/EIN/IEM/IL Number
                                </td>
                                <td>
                                    <span>
                        ...
                        <tr>
                            ...
                            <tr id="TRCLAIMPERIOD" runat="server" visible="false">
                                <td style="width: 2%"></td>
                                <td class="auto-style1">13. Claim Period
                                </td>
                                <td>
                                    <span>
                            ...
                            <tr id="TRSCHEME" runat="server">
                                ...
                                <td>
                                    <span>
                                        <asp:Label ID="LBLSCHEME" runat="server">TTAP</asp:Label>
                                    </span>
                                </td>
                            </tr>
                            <tr runat="server" visible="false">
                            ...
                            <tr id="clerkattachment" runat="server" visible="false">
                                <td style="width: 2%"></td>
                                <td class="auto-style1">15. Clerk Worksheet
                                </td>
                                <td>
                                    <span>
                        ...
                        <%-- <div align="center" runat="server" visible="false">
                            <table style="font-family: Verdana; font-size: small; width: 100%">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td align="center">Details of Fixed Assets
                                    </td>
                                    <td align="center">
                    ...
                    <div>
                        <div align="center" id="Div3" runat="server">
                            <table bgcolor="White" style="font-family: Verdana; font-size: small;" width="100%">
                                <tr>
                                    <td colspan="4" style="color: black; font-weight: bold;" class="auto-style8">12 <u>ELIGIBLE INCENTIVES </u>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style8">a) Investment Subsidy @ Eligible %
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style8">b) State Investment Subsidy in Rs.
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">c) Additional Women Percentage(%).
                                    </td>
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">d) Addl Sub. for Women in Rs.
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">e) Application Type
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">f) Is LMV or NONLMV
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">g) Is Men or Women
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">h) Remarks
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr runat="server" visible="false" id="trgmremarks">
                                    ...
                                    <td colspan="2" style="text-align: justify">The GM,DIC -
                        ...
                        <div align="center" id="divLandconversion" visible="false" runat="server">
                            <table bgcolor="White" style="font-family: Verdana; font-size: small;" width="100%">
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td style="color: black; font-weight: bold;" class="auto-style8">4.0 <u>ELIGIBLE INCENTIVES </u>
                                    </td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style8">4.1 Land measuring in Square meters
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style8">4.2 Land Conversion Charges Paid:
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">4.3 Building plinth Area in Square meters
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">4.4 Five Times plinth area:
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">4.5 Land Area Considered:
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">4.6 Proportionate Land Conversion Charges
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">4.7 (25 %) on computed value in Rs.
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">4.8 Value Recommended by GM
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">4.9 Elegible Land conversion charges in Rs.
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">4.10 Type of Claim
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">4.11 Remarks
                                    </td>
                                    <td class="auto-style4">
                        ...
                        <div align="center" id="divmortgage" visible="false" runat="server">
                            <table bgcolor="White" style="font-family: Verdana; font-size: small;" width="100%">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style8">4.1 Name of the Financial Institution
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style8">4.2 Term Loan Sacnctioned
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">4.3 Mortgage Duty Paid
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">4.4 Term Loan availed by Unit
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">4.5 Proportionate Mortgage Duty
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">4.6 Mortgage Duty Recommended by GM
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">4.7 Elegible for Reimbursement of Mortgage Duty in Rs.
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">4.8 Type of Claim
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">4.9 Remarks
                                    </td>
                                    <td class="auto-style4">
                        ...
                        <div align="center" id="divlandcost" visible="false" runat="server">
                            <table bgcolor="White" style="font-family: Verdana; font-size: small;" width="100%">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style8">4.1 Land Purchase in Sq. Mts.
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style8">4.2 Land Value in Rs
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">4.3 Plinth Area in Sq.Mts.
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">4.4 Five times of Builtup Area (Sq.Mts.)
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">4.5 Proportionate value in Rs.
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">4.6 Value recommended by G.M., DIC. in Rs.
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">4.7 Eligible Land Cost in Rs.
                                    </td>
                                    <td class="auto-style4">
                        ...
                        <div align="center" id="divStampduty" visible="false" runat="server">
                            <table bgcolor="White" style="font-family: Verdana; font-size: small;" width="100%">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style8">4.1 Land measuring in Sq. Mts.
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style8">4.2 Stamp duty paid by the unit in Rs.
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">4.3 Building plinth area in Sq.Mts.
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">4.4 Building plinth area 5 times (Sq.Mts.)
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">4.5 Proportionate value for the area in Rs.
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">4.7 Value Computed in Rs.
                                    </td>
                                    <td class="auto-style4">
                        ...
                        <div align="center" id="DIVQUALITYCERTIFICATION" visible="false" runat="server">
                            <table bgcolor="White" style="font-family: Verdana; font-size: small;" width="100%">
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td style="color: black; font-weight: bold;" class="auto-style8">4.0 <u>QUALITY CERTIFICATION </u>
                                    </td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style8">4.1 Quality certification charges paid
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style8">4.2 50% of amount of certification charges paid
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">4.3 G.M Recommended Amount
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">4.4 Eligible amount whichever is less
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">4.5 Type of Claim
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">4.6 Remarks
                                    </td>
                                    <td class="auto-style4">
                        ...
                        <div>
                            <table id="tblNewUnit" runat="server" visible="false" style="font-family: Verdana; font-size: small;"
                                bgcolor="White" width="100%">
                                <tr>
                                    <td style="border: solid thin black; font-weight: bold;">Financial Year
                                    </td>
                                    <td style="border: solid thin black; font-weight: bold;">Month-year
                                    </td>
                                    <td style="border: solid thin black; font-weight: bold;">Units Consumed
                                    <br />
                                        in Nos.
                                    </td>
                                    <td style="border: solid thin black; font-weight: bold;">Rate per
                                    <br />
                                        Units
                                    </td>
                                    <td style="border: solid thin black; font-weight: bold;">Amount Paid as per Bill in Rs.
                                    </td>
                                    <td style="border: solid thin black; font-weight: bold;">Eligible rate Re-imbursement per units
                                    </td>
                                    <td style="border: solid thin black; font-weight: bold;">Eligible amount Re-imbursement per units
                                    </td>
                            ...
                            <table id="tblNewUnitBoth" runat="server" visible="false" style="font-family: Verdana; font-size: small;"
                                bgcolor="White" width="100%">
                                <tr>
                                    <td style="border: solid thin black; font-weight: bold;">Financial Year
                                    </td>
                                    ...
                                    <td>
                                        <table id="tbl_monthyeardataExpansion" runat="server" visible="false" bgcolor="White"
                                            ...
                                            <tr>
                                                ...
                                                <td style="border: solid thin black; font-weight: bold;">Rate per Units
                                                </td>
                                                <td style="border: solid thin black; font-weight: bold;">Amount Paid as per Bill in Rs.
                                                </td>
                                                <td style="border: solid thin black; font-weight: bold;">Base fixed per month in units
                                                </td>
                                                <td style="border: solid thin black; font-weight: bold;">Eligible Units i.e over & above Base
                                                </td>
                                                <td style="border: solid thin black; font-weight: bold;">Eligible Rate for
                                                <br />
                                                    Reimbursement per units
                                                </td>
                                                <td style="border: solid thin black; font-weight: bold;">Eligible amount for
                                                <br />
                            ...
                            <table>
                                <tr>
                                    <td>
                                        <table id="Table1" runat="server" visible="false" bgcolor="White" width="100%" style="font-family: Verdana; font-size: small;">
                                            <tr>
                                                <td style="border: solid thin black; font-weight: bold;">Financial Year
                                                </td>
                                                <td style="border: solid thin black; font-weight: bold;">Month-year
                        ...
                        <div id="Div1" runat="server" align="left" visible="false">
                            <asp:Label ID="lblfinalsubsidyamount" runat="server" Text="Final Subsidy Amount" Visible="false"></asp:Label>:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <div align="center" id="DIVSALESTAX" visible="false" runat="server">
                            <table bgcolor="White" style="font-family: Verdana; font-size: small;" width="100%">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style8">i. Scheme Type
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style8">ii. Application Type
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">iii. Production
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">iv. Tax Paid
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">v. Base Production
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">vi. Eligible Production Quantity over and the above base production
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">vii. Proportionate SGST value on eligible prodution
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">viii. Category
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">ix. Percentage
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr runat="server" visible="false" id="trcapitaleligibleinvestment">
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">x. Total Capital Eligible Investment
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr runat="server" visible="false" id="trsalestaxsanctionedonthisclaim">
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">xi. Total Sales Tax Already Sanctioned Prior to This Claim
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">xii. GM Recommended Value
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">xiii. Eligible Amount
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">xiv. Type of claim
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">xv. Remarks
                                    </td>
                                    <td class="auto-style4">
                        ...
                        <div align="center" id="div_pallavaddi" visible="false" runat="server">
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <table>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="font-family: Calibri">&nbsp;&nbsp;&nbsp; &nbsp;<b>Loan installment start Date</b>
                                                                </td>
                                                                <td style="font-family: Calibri">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="font-family: Calibri">&nbsp;&nbsp;&nbsp; &nbsp;<b>Period of installment</b>
                                                                </td>
                                                                <td style="font-family: Calibri">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="font-family: Calibri">&nbsp;&nbsp;&nbsp; &nbsp;<b>Installment amount</b>
                                                                </td>
                                                                <td style="font-family: Calibri">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="font-family: Calibri">&nbsp;&nbsp;&nbsp; &nbsp;<b>Principal Amount become Due before this Half Year</b>
                                                                </td>
                                                                <td style="font-family: Calibri">
                                                                ...
                                                                <td colspan="4">
                                                                    <table border="1" width="100%" align="center" cellpadding="10" cellspacing="5">
                                                                        <tr style="column-rule-style: solid">
                                                                            <th style="font-family: Calibri">Sr.#
                                                                            </th>
                                                                            <th style="font-family: Calibri">Period of Claim
                                                                            </th>
                                                                            <th style="font-family: Calibri">Principal amounnt due
                                                                            </th>
                                                                            <th style="font-family: Calibri">No of Installment
                                                                            </th>
                                                                            <th style="font-family: Calibri">Rate of Interest
                                                                            </th>
                                                                        ...
                                                                        <tr>
                                                                            <td style="font-family: Calibri">1
                                                                            </td>
                                                                            <td style="font-family: Calibri">
                                                                        ...
                                                                        <tr>
                                                                            <td style="font-family: Calibri">2
                                                                            </td>
                                                                            <td style="font-family: Calibri">
                                                                        ...
                                                                        <tr>
                                                                            <td style="font-family: Calibri">3
                                                                            </td>
                                                                            <td style="font-family: Calibri">
                                                                        ...
                                                                        <tr>
                                                                            <td style="font-family: Calibri">4
                                                                            </td>
                                                                            <td style="font-family: Calibri">
                                                                        ...
                                                                        <tr>
                                                                            <td style="font-family: Calibri">5
                                                                            </td>
                                                                            <td style="font-family: Calibri">
                                                                        ...
                                                                        <tr>
                                                                            <td style="font-family: Calibri">6
                                                                            </td>
                                                                            <td style="font-family: Calibri">
                                                            ...
                                                            <tr>
                                                                <td style="font-family: Calibri">
                                                                    <b>Interest amount to be paid as per calculations</b>
                                                                </td>
                                                                <td style="font-family: Calibri">
                            ...
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <td style="padding: 5px; margin: 5px;">Interest amount to be paid as per calculations
                                    </td>
                                ...
                                <tr>
                                    <td style="padding: 5px; margin: 5px;" class="ui-priority-primary"></td>
                                    <td style="padding: 5px; margin: 5px;">Actual interest amount paid
                                    </td>
                                    <td style="padding: 5px; margin: 5px;">:
                                    </td>
                                    <td style="padding: 5px; margin: 5px;" class="auto-style28">
                                ...
                                <tr>
                                    <td style="padding: 5px; margin: 5px;" class="ui-priority-primary"></td>
                                    <td style="padding: 5px; margin: 5px;">Considered Amount of Interest
                                    </td>
                                    <td style="padding: 5px; margin: 5px;">:
                                    </td>
                                    <td style="padding: 5px; margin: 5px;" class="auto-style28">
                                ...
                                <tr>
                                    <td style="padding: 5px; margin: 5px;" class="ui-priority-primary"></td>
                                    <td style="padding: 5px; margin: 5px;">GM recommended amount
                                    </td>
                                    <td style="padding: 5px; margin: 5px;">:
                                    </td>
                                    <td style="padding: 5px; margin: 5px;" class="auto-style28">
                                ...
                                <tr>
                                    <td style="padding: 5px; margin: 5px;" class="ui-priority-primary"></td>
                                    <td style="padding: 5px; margin: 5px;">Eligible amount
                                    </td>
                                    <td style="padding: 5px; margin: 5px;">:
                                    </td>
                                    <td style="padding: 5px; margin: 5px;" class="auto-style28">
                                ...
                                <tr>
                                    <td style="padding: 5px; margin: 5px;" class="ui-priority-primary"></td>
                                    <td style="padding: 5px; margin: 5px;">Remarks given by Clerk
                                    </td>
                                    <td style="padding: 5px; margin: 5px;">:
                                    </td>
                                    <td style="padding: 5px; margin: 5px;" class="auto-style28">
                        ...
                        <div align="center" id="divcoal" visible="false" runat="server">
                            <table bgcolor="White" style="font-family: Verdana; font-size: small;" width="100%">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style8">Coal Quantity
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style8">Eligible Amount
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">GM Recommended Value
                                    </td>
                                    <td class="auto-style4">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">Final Subsidy Amount
                                    </td>
                                    <td class="auto-style4">
                        ...
                        <div align="center" id="DIVWOOD" visible="false" runat="server">
                            <table bgcolor="White" style="font-family: Verdana; font-size: small;" width="100%">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style8">WOOD Quantity
                                    </td>
                                    <td>
                        ...
                        <div align="center" id="DIVTRANSPORTDUTY" visible="false" runat="server" style="padding-left: 40px">
                            <table runat="server" style="font-family: Verdana; font-size: small;"
                                bgcolor="White" width="100%">
                                <tr>
                                    <td style="border: solid thin black; font-weight: bold;">Month
                                    </td>
                                    <td style="border: solid thin black; font-weight: bold;">Financial-year
                                    </td>
                                    <td style="border: solid thin black; font-weight: bold;">Units Consumed
                                    ...
                                    <td style="border: solid thin black; font-weight: bold;">Eligible amount Re-imbursement in Rs.
                                    </td>
                                    <th style="padding: 10px; margin: 5px; font-weight: bold;">&nbsp;
                                    </th>
                                </tr>
                        ...
                        <br />
                        <div align="center" id="divspecificcleaner" visible="false" runat="server">
                            <table bgcolor="White" style="font-family: Verdana; font-size: small;"
                                width="100%">
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td style="color: black; font-weight: bold;" class="auto-style8">
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style8">Expenditure Incurred.
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style8">25% Expenditure Incurred.
                                    </td>
                                    <td>
                                        <asp:Label ID="lblExpenditure25" runat="server"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">Value recommended by G.M., DIC. in Rs.
                                    </td>
                                    <td class="auto-style4">
                                        <asp:Label ID="lblgmspecific" runat="server"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">Final Value Computed in Rs.
                                    </td>
                                    <td class="auto-style4">
                                        <asp:Label ID="lvlfinalpecific" runat="server"></asp:Label>
                                    </td>
                                </tr>
                                <tr runat="server" visible="false">
                                    <td style="width: 2%"></td>
                                    <td class="auto-style8"><b>TOTAL SUBSIDY(4.2 + 4.3)</b></td>
                                    <td>
                        ...
                        <br />
                        <div align="center" id="DIVSKILLUPGRADE" visible="false" runat="server">
                            <table bgcolor="White" style="font-family: Verdana; font-size: small;" width="100%">
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td style="color: black; font-weight: bold;" class="auto-style8">4.0 <u>Reimbursement of cost involved in skill upgradation and training </u>
                                    </td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style8">4.1 Skill Upgradation charges paid
                                    </td>
                                    <td>
                                        <asp:Label ID="lblskillupchargespaid" runat="server"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style8">4.2 50% of amount of skill upgradation charges paid
                                    </td>
                                    <td>
                                        <asp:Label ID="lbl50perskillupchargespaid" runat="server"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 2%"></td>
                                    ...
                                    <td class="auto-style4">
                                        <asp:Label ID="lblgmrecomamount_skillupgrade" runat="server"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 2%"></td>
                                    ...
                                    <td class="auto-style4">
                                        <asp:Label ID="lblelegamountless_skillupgrade" runat="server"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 2%"></td>
                                    ...
                                    <td class="auto-style4">
                                        <asp:Label ID="lbltypeofclaim_skillupgrade" runat="server"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 2%"></td>
                                    ...
                                    <td class="auto-style4">
                                        <asp:Label ID="lblremarks_skillupgrade" runat="server"></asp:Label>
                                    </td>
                                </tr>
                        ...
                        <div align="center" id="DIVIIDF" visible="false" runat="server">
                            <table bgcolor="White" style="font-family: Verdana; font-size: small;" width="100%">
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td style="color: black; font-weight: bold;" class="auto-style8">
                                        <u>Industrial Infrastructure Development Fund(IIDF) </u>
                                    </td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style8">a. IIDF  charges paid
                                    </td>
                                    <td>
                                        <asp:Label ID="lbliidfchargespaid" runat="server"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style8">b. 50% of amount of IIDF  charges paid
                                    </td>
                                    <td>
                                        <asp:Label ID="lbl50perofiidf" runat="server"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style8">c. 15% of amount of computed cost
                                    </td>
                                    <td>
                                        <asp:Label ID="lbl15perofcompcost" runat="server"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">d. G.M Recommended Amount
                                    </td>
                                    <td class="auto-style4">
                                        <asp:Label ID="lblgmrecomamount_iidf" runat="server"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">e. Eligible amount whichever is less
                                    </td>
                                    <td class="auto-style4">
                                        <asp:Label ID="lblelegamountless_iidf" runat="server"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">f. Type of Claim
                                    </td>
                                    <td class="auto-style4">
                                        <asp:Label ID="lbltypeofclaim_iidf" runat="server"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 2%"></td>
                                    <td class="auto-style18">g. Remarks
                                    </td>
                                    <td class="auto-style4">
                                        <asp:Label ID="lblremarks_iidf" runat="server"></asp:Label>
                                    </td>
                                </tr>
