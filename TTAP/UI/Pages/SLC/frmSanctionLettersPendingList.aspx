<%@ Page Title="" Language="C#" MasterPageFile="~/UI/UserMaster.Master" AutoEventWireup="true" CodeBehind="frmSanctionLettersPendingList.aspx.cs" Inherits="TTAP.UI.Pages.SLC.frmSanctionLettersPendingList" %>
                ...
                <div id="content-header">
                    ...
                    <div class="breadcrumb-bg">
                        <ul class="breadcrumb font-medium title5 container">
                            ...
                            <li class="breadcrumb-item">Pending Issue Sanctions Letters</li>
                        </ul>
                    </div>
                </div>
                                ...
                                <div class="widget-content nopadding">
                                    <div class="row" id="divPrint" runat="server">
                                        <div class="row col-sm-12">
                                            ...
                                            <div class="col-sm-6 col-md-3 form-group" style="margin-top: 13px;">
                                                   ...
                                                   <%-- <asp:TemplateField HeaderStyle-CssClass="text-center" HeaderText="Status">
                                                    ...
                                                    <asp:TemplateField HeaderText="Incentiveid" Visible="false">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:Label ID="lblIsPartial" Text='<%#Eval("PartialSanction") %>' runat="server" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
