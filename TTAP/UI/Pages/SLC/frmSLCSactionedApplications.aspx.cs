...
{
    public partial class frmSLCSactionedApplications : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.Redirect("frmSLCAllApplicationst.aspx?Cast=" + lblCategory1 + "&MstIncentiveId=" + lblMstIncentiveId + "&SubIncId=" + lblSubIncType +
        ...
        public void getallapproveddipcno()
        {
            ...
            ds = ObjCAFClass.GenericFillDs("USP_GET_LIST_INCENTIVE_SLCSanctionNO", pp);
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            ds = ObjCAFClass.GenericFillDs("USP_GET_ABSTRACT_SLC_APPROVED", pp);
