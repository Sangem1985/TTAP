...
{
    public partial class ISLCSactionedApplications : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.Redirect("ISLCAllApplicationsList.aspx?Cast=" + lblCategory1 + "&MstIncentiveId=" + lblMstIncentiveId + "&SubIncId=" + lblSubIncType +
        ...
        public void getallapproveddipcno()
        {
            ...
            pp[0].Value = Distid;
            ds = ObjCAFClass.GenericFillDs("USP_GET_LIST_INCENTIVE_SLCSanctionNO_I", pp);
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            ds = ObjCAFClass.GenericFillDs("USP_GET_ABSTRACT_SLC_APPROVED_I", pp);
