<%@ Page Title="" Language="C#" MasterPageFile="~/UI/UserMaster.Master" AutoEventWireup="true" CodeBehind="frmSLCGeneratedAgendaAbstract.aspx.cs" Inherits="TTAP.UI.Pages.SLC.frmSLCGeneratedAgendaAbstract" %>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 form-group">
                                            <div class="row py-4">
                                                ...
                                                <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                                                    <asp:Button ID="btnGetDLClist" CssClass="btn btn-blue py-1 title7 mt-1" runat="server" Text="Get Proposed SLC Agenda" OnClick="btnGetDLClist_Click" />
                                                </div>
                                            </div>
                                        </div>
