<%@ Page Title="" Language="C#" MasterPageFile="~/UI/UserMaster.Master" AutoEventWireup="true" CodeBehind="frmApllicationsforQueryDrill.aspx.cs" Inherits="TTAP.UI.Pages.QueryGeneration.frmApllicationsforQueryDrill" %>
                    ...
                    <div class="w-100 px-3 frm-form box-content py-3 font-medium title5">
                        ...
                        <div class="widget-content nopadding">
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                     <asp:Button ID="btnGenerateQueryLetter" runat="server" CssClass="btn btn-blue mx-2 px-4 py-1 title5"
                                        TabIndex="5" Text="Generate New Query Letter" OnClick="btnGenerateQueryLetter_Click" />
                                </div>
                                ...
                                <div class="col-sm-12 table-responsive">
                                    <asp:GridView ID="gvdetailsnew" runat="server" AllowPaging="false" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="LetterNo" ItemStyle-HorizontalAlign="Center" HeaderText="Letter No">
                                                <ItemStyle CssClass="text-left" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="LetterDate" ItemStyle-HorizontalAlign="Center" HeaderText="Date of Submit">
                                                <ItemStyle CssClass="text-left" />
                                            </asp:BoundField>
