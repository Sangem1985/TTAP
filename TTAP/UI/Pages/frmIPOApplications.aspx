<%@ Page Title="" Language="C#" MasterPageFile="~/UI/UserMaster.Master" AutoEventWireup="true" CodeBehind="frmIPOApplications.aspx.cs" Inherits="TTAP.UI.Pages.frmIPOApplications" %>
            ...
            <div id="content">
                <div id="content-header">
                    <div id="breadcrumb" class="d-none">
                        ...
                        <a href="#" class="current" runat="server" id="acurrentpage">IPO Applications</a>
                    </div>
                    <div class="breadcrumb-bg">
                        <ul class="breadcrumb font-medium title5 container">
                            <li class="breadcrumb-item"><a href="frmDashBoard.aspx">Home</a></li>
                            <li class="breadcrumb-item">IPO Applications</li>
                        </ul>
                    </div>
                </div>
                <div class="container-fluid mt-4 pb-4" id="Receipt" runat="server">
                    <div class="w-100 px-3 frm-form box-content py-3 font-medium title5">
                        <h5 class="text-blue mt-1 mb-3 font-SemiBold">IPO Applications</h5>
