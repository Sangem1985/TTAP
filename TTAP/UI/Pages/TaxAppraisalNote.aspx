<%@ Page Title="" Language="C#" MasterPageFile="~/UI/UserMaster.Master" AutoEventWireup="true" CodeBehind="TaxAppraisalNote.aspx.cs" Inherits="TTAP.UI.Pages.TaxAppraisalNote" %>
                ...
                <div id="content-header">
                    <div class="breadcrumb-bg">
                        <ul class="breadcrumb font-medium title5 container">
                            ...
                            <li class="breadcrumb-item" id="Sublinkname" runat="server">Apprisal Note of Reimbursement of TAX</li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="w-100 px-4 frm-form box-content py-4 font-medium title5">
                        <div class="row-fluid">
                            <div class="widget-box">
                                <div class="widget-title">
                                    ...
                                    <h5 class="text-blue mb-3 font-SemiBold  col col-sm-12 mt-3 text-center" runat="server" id="HMainheading">Apprisal Note of Reimbursement of TAX</h5>
                                </div>
                        ...
                        <asp:TextBox ID="txtPlintharea423" runat="server" class="form-control txtbox txtcomn" Height="30px" MaxLength="80" TabIndex="35" onkeypress="return inputOnlyNumbers(event)"  Width="150px"></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td class="auto-style48">&nbsp;&nbsp;Production</td>
                                                <td class="auto-style48">&nbsp;</td>
                                                <td class="auto-style48">

                                                    <asp:TextBox ID="TXTPRODUCTION" runat="server" class="form-control txtbox txtcomn" onkeypress="return inputOnlyNumbers(event)" oncopy="return false" onpaste="return false" oncut="return false"
                                                        Height="30px" MaxLength="80" TabIndex="34" Width="150px" AutoPostBack="true" OnTextChanged="TXTPRODUCTION_TextChanged"></asp:TextBox>
                                            ...
                                            <tr>
                                                <td class="auto-style56"></td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style57">Tax Paid(SGST)</td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style56">:</td>
                                                <%--  <td style="padding: 5px; margin: 5px; ">
                        <asp:TextBox ID="txt423guideline" runat="server" class="form-control txtbox txtcomn" Height="30px" MaxLength="80" TabIndex="34"  Width="150px" onkeypress="return inputOnlyNumbers(event)"></asp:TextBox>
                    </td>--%>
                                                <td class="auto-style56">
                                                    ...
                                                    <asp:TextBox ID="TXTTAXPAID" runat="server" class="form-control txtbox txtcomn" onkeypress="return inputOnlyNumbers(event)" oncopy="return false" onpaste="return false" oncut="return false"
                                                        Height="30px" MaxLength="80" TabIndex="34" Width="150px" AutoPostBack="true" OnTextChanged="TXTTAXPAID_TextChanged"></asp:TextBox>
                                                </td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style56">&nbsp;
                                                </td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style56"></td>
                        ...
                        <asp:TextBox ID="txtPlintharea423" runat="server" class="form-control txtbox txtcomn" Height="30px" MaxLength="80" TabIndex="35" onkeypress="return inputOnlyNumbers(event)"  Width="150px"></asp:TextBox>
                                            ...
                                            <tr>
                                                <td class="auto-style56"></td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style57">Base Production</td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style56">:</td>
                                                <%--  <td style="padding: 5px; margin: 5px; ">
                        <asp:TextBox ID="txt423guideline" runat="server" class="form-control txtbox txtcomn" Height="30px" MaxLength="80" TabIndex="34"  Width="150px" onkeypress="return inputOnlyNumbers(event)"></asp:TextBox>
                    </td>--%>
                                                <td class="auto-style56">
                                                    ...
                                                    <asp:TextBox ID="TXTBASEPRODUCTION" runat="server" class="form-control txtbox txtcomn"
                                                        Height="30px" MaxLength="80" TabIndex="34" Width="150px" Enabled="false" OnTextChanged="TXTBASEPRODUCTION_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                </td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style56">&nbsp;
                                                </td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style56"></td>
                        ...
                        <asp:TextBox ID="txtPlintharea423" runat="server" class="form-control txtbox txtcomn" Height="30px" MaxLength="80" TabIndex="35" onkeypress="return inputOnlyNumbers(event)"  Width="150px"></asp:TextBox>
                                            ...
                                            <tr>
                                                <td class="auto-style56"></td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style57">Eligible Production Qty over and above base production</td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style56">:</td>
                                                <%--  <td style="padding: 5px; margin: 5px; ">
                        <asp:TextBox ID="txt423guideline" runat="server" class="form-control txtbox txtcomn" Height="30px" MaxLength="80" TabIndex="34"  Width="150px" onkeypress="return inputOnlyNumbers(event)"></asp:TextBox>
                    </td>--%>
                                                <td class="auto-style56">
                                                    ...
                                                    <asp:TextBox ID="TXTELIGIBLEPRODUCTIONQTY" runat="server" class="form-control txtbox txtcomn"
                                                        Height="30px" MaxLength="80" TabIndex="34" Width="150px" Enabled="false"></asp:TextBox>
                                                </td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style56">&nbsp;
                                                </td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style56"></td>
                        ...
                        <asp:TextBox ID="txtPlintharea423" runat="server" class="form-control txtbox txtcomn" Height="30px" MaxLength="80" TabIndex="35" onkeypress="return inputOnlyNumbers(event)"  Width="150px"></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">Proportinate SGST value on eligible production</td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">:</td>
                                                <td class="auto-style55">
                                                    <asp:TextBox ID="TXTPROPORTINATESGSTVALUE" runat="server" class="form-control txtbox txtcomn"
                                            ...
                                            <tr id="TRCAPITALELIGIBLEINVESTMENT" runat="server" >
                                                <td class="auto-style55"></td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">TOTAL CAPITAL ELIGIBLE INVESTMENT</td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                                                <td class="auto-style55">
                                                    <asp:TextBox ID="TXTCAPITALELIGIBLEINVESTMENT" AutoPostBack="true" runat="server" class="form-control txtbox txtcomn"
                                                        Height="30px" onkeypress="return inputOnlyNumbers(event)" MaxLength="80" TabIndex="36"
                                            ...
                                            <tr id="TRTOTALSALESTAXSANCTIONED" runat="server">
                                                <td class="auto-style55"></td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">TOTAL SALES TAX ALREADY SANCTIONED PRIOR TO THIS CLAIM</td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                                                <td class="auto-style55">
                                                    <asp:TextBox ID="TXTSALESTAXSANCTIONED" runat="server" class="form-control txtbox txtcomn"
                                                        Height="30px" onkeypress="return inputOnlyNumbers(event)" MaxLength="80" TabIndex="36" AutoPostBack="true" OnTextChanged="TXTSALESTAXSANCTIONED_TextChanged"
                                                        Width="150px"></asp:TextBox>
                                                </td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="auto-style55"></td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">Category</td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                                                <td class="auto-style55">
                                                    <asp:DropDownList ID="DDLCATEGORY" runat="server" class="form-control txtbox" TabIndex="5"
                                                        Height="33px" Width="180px" AutoPostBack="True" Visible="true" OnSelectedIndexChanged="DDLCATEGORY_SelectedIndexChanged">
                                                        <asp:ListItem Value="0">--Select--</asp:ListItem>
                                                        <asp:ListItem Value="1">A5</asp:ListItem>
                                                        <asp:ListItem Value="2">A4</asp:ListItem>
                                                        <asp:ListItem Value="3">A3</asp:ListItem>
                                                        <asp:ListItem Value="4">A2</asp:ListItem>
                                                        <asp:ListItem Value="5">A1</asp:ListItem>
                                                    </asp:DropDownList>
                                                </td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                                            ...
                                            <tr id="TRMEGA" runat="server" visible="false">
                                                <td class="auto-style55"></td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">MEGA</td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                                                <td class="auto-style55">
                                                    <asp:TextBox ID="TXTMEGA" AutoPostBack="true" runat="server" class="form-control txtbox txtcomn"
                                                        Height="30px" onkeypress="return inputOnlyNumbers(event)" Enabled="false" MaxLength="80" TabIndex="36" OnTextChanged="TXTMEGA_TextChanged"
                                                        Width="150px"></asp:TextBox>
                                                </td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                                            ...
                                            <tr id="TRLARGE" runat="server" visible="false">
                                                <td class="auto-style55"></td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">LARGE</td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                                                <td class="auto-style55">
                                                    <asp:TextBox ID="TXTLARGE" runat="server" class="form-control txtbox txtcomn"
                                            ...
                                            <tr id="TRMEDIUM" runat="server" visible="false">
                                                <td class="auto-style55"></td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">MEDIUM</td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                                                <td class="auto-style55">
                                                    <asp:TextBox ID="TXTMEDIUM" runat="server" class="form-control txtbox txtcomn"
                                                        Height="30px" onkeypress="return inputOnlyNumbers(event)" Enabled="false" MaxLength="80" TabIndex="36"
                                                        Width="150px"></asp:TextBox>
                                                </td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                                            ...
                                            <tr id="TRSMALL" runat="server" visible="false">
                                                <td class="auto-style55"></td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">SMALL</td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                                                <td class="auto-style55">
                                                    <asp:TextBox ID="TXTSMALL" runat="server" class="form-control txtbox txtcomn"
                                                        Height="30px" onkeypress="return inputOnlyNumbers(event)" Enabled="false" MaxLength="80" TabIndex="36"
                                                        Width="150px"></asp:TextBox>
                                                </td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                                            ...
                                            <tr id="TRMICRO" runat="server" visible="false">
                                                <td class="auto-style55"></td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">MICRO</td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                                                <td class="auto-style55">
                                                    <asp:TextBox ID="TXTMICRO" runat="server" class="form-control txtbox txtcomn"
                                                        Height="30px" onkeypress="return inputOnlyNumbers(event)" Enabled="false" MaxLength="80" TabIndex="36"
                                                        Width="150px"></asp:TextBox>
                                                </td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                                            ...
                                            <tr>
                                                <td class="auto-style55"></td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">AMOUNT</td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                                                <td class="auto-style55">
                                                    <asp:TextBox ID="TXTELIGIBLEAMOUNT" runat="server" class="form-control txtbox txtcomn"
                                                        Height="30px" onkeypress="return inputOnlyNumbers(event)" Enabled="false" MaxLength="80" TabIndex="36"
                                                        Width="150px"></asp:TextBox>
                                                </td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                        ...
                        <asp:TextBox ID="txtPlintharea423" runat="server" class="form-control txtbox txtcomn" Height="30px" MaxLength="80" TabIndex="35" onkeypress="return inputOnlyNumbers(event)"  Width="150px"></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                                                <td class="auto-style55">
                                                    <asp:TextBox ID="txtgmRecommend" runat="server" class="form-control txtbox txtcomn"
                                                        Height="30px" onkeypress="return inputOnlyNumbers(event)" Enabled="false" MaxLength="80" TabIndex="36"
                                                        Width="150px"></asp:TextBox>
                                                </td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                                            ...
                                            <tr>
                                                <td class="auto-style55"></td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">ELIGIBLE AMOUNT</td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                                                <td class="auto-style55">
                                                    <asp:TextBox ID="TXTFINALELIGIBLEAMOUNT" runat="server" class="form-control txtbox txtcomn"
                                                        Height="30px" onkeypress="return inputOnlyNumbers(event)" Enabled="false" MaxLength="80" TabIndex="36"
                                                        Width="150px"></asp:TextBox>
                                                </td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                                            ...
                                            <tr>
                                                <td class="auto-style55"></td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">FINAL SUBSIDY AMOUNT</td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                                                <td class="auto-style55">
                                                    <asp:TextBox ID="TXTFINALSUBSIDYAMOUNT" runat="server" class="form-control txtbox txtcomn"
                                                        Height="30px" onkeypress="return inputOnlyNumbers(event)" MaxLength="80" TabIndex="36"
                                                        Width="150px"></asp:TextBox>
                                                </td>
                                                <td style="padding: 5px; margin: 5px;" class="auto-style55">&nbsp;</td>
                                            ...
                                            <tr runat="server" visible="false">
                                                ...
                                                <td>&nbsp;
                            <asp:TextBox ID="txtvalue424" runat="server" class="form-control txtbox txtcomn" Height="30px" MaxLength="80" onkeypress="return inputOnlyNumbers(event)" Enabled="false" TabIndex="37" Width="150px"></asp:TextBox>
                                                </td>
                                                <td style="padding: 5px; margin: 5px;">&nbsp;
                                                </td>
                                                <td style="padding: 5px; margin: 5px;">&nbsp;</td>
