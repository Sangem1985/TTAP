<%@ Page Title="" Language="C#" MasterPageFile="~/UI/UserMaster.Master" AutoEventWireup="true" CodeBehind="frmDeptAdminDashBoard.aspx.cs" Inherits="TTAP.UI.Pages.frmDeptAdminDashBoard" %>
            ...
            <div id="content">
                ...
                <div class="container mt-4 pb-4" id="Receipt" runat="server">
                    <div class="w-100 px-3 frm-form box-content py-3 font-medium title5">
                        <h5 class="text-blue mt-1 mb-3 font-SemiBold">Department Admin Dashboard</h5>
                        <div class="widget-content nopadding">
                            ...
                            <div class="row" id="Div1" runat="server">
                                <div class="col-sm-6 mb-4">
                                    <div class="list-group">
                                        <a class="list-group-item d-flex justify-content-between align-items-center font-SemiBold list-group-item-action" href="frmDraftApplicationsDrill.aspx?Stg=1">
                                            <span><i class="fa fa-fw fa-calendar"></i>Total Draft Applications</span>
                                            <span class="badge badge-pill badge-primary bg-blue">
                                                <asp:Label ID="lbldraftApplications" runat="server"></asp:Label>
                                            </span>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="row" id="trsection1" runat="server" visible="false">
                                <div class="col-sm-6 mb-4">
                                    <div class="list-group">
                                        <%--  <a class="list-group-item"><i class="fa fa-fw fa-check"></i><b>Incentive (Application Stage)</b> </a>--%>
                                        <a class="list-group-item d-flex justify-content-between align-items-center font-SemiBold list-group-item-action" href="frmDeptAdminDrill.aspx?Stg=1">
                                            <span><i class="fa fa-fw fa-calendar"></i>Total Applications Received</span>
                                            <span class="badge badge-pill badge-primary bg-blue">
                                                <asp:Label ID="lblAppladmin" runat="server"></asp:Label>
                                            </span>
                                        </a>
                                        <a class="list-group-item d-flex justify-content-between align-items-center font-SemiBold text-blue list-heading-bg">
                                            <span><i class="fa fa-fw fa-check"></i>Applications Received</span>
                                        </a>
                                        <a class="list-group-item d-flex justify-content-between align-items-center list-group-item-action" href="frmDeptAdminDrill.aspx?Stg=2">
                                            <span><i class="fa fa-fw fa-calendar"></i>Yet to Verify</span>
                                            <span class="badge badge-pill badge-success">
                                                <asp:Label ID="lblPendingWithinadmin" runat="server"></asp:Label>
                                            </span>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <h6 class="text-blue mt-1 mb-3 font-SemiBold">RTGS/NEFT Payment Verification Dashboard</h6>
                                ...
                                <div class="col-sm-6 mb-4">
                                    <div class="list-group">
                                        ...
                                        <a class="list-group-item d-flex justify-content-between align-items-center font-SemiBold list-group-item-action" href="frmDeprApprovalDrill.aspx?Stg=1">
                                            <span><i class="fa fa-fw fa-calendar"></i>Total Applications Received</span>
                                            <span class="badge badge-pill badge-primary bg-blue">
                                                <asp:Label ID="lblApplpayment" runat="server"></asp:Label>
                                            </span>
                                        </a>
                                        <a class="list-group-item d-flex justify-content-between align-items-center font-SemiBold text-blue list-heading-bg">
                                        ...
                                        <a class="list-group-item d-flex justify-content-between align-items-center list-group-item-action" href="frmDeprApprovalDrill.aspx?Stg=2">
                                            <span><i class="fa fa-fw fa-calendar"></i>Yet to Verify</span>
                                            <span class="badge badge-pill badge-success">
                                                <asp:Label ID="lblPendingWithinpayment" runat="server"></asp:Label>
                                            </span>
                                        </a>
                                        <a class="list-group-item d-flex justify-content-between align-items-center list-group-item-action" href="frmDeprApprovalDrill.aspx?Stg=3">
                                            ...
                                            <span class="badge badge-pill badge-success">
                                                <asp:Label ID="lblpendingTotalpayment" runat="server"></asp:Label>
                                            </span>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <h6 class="text-blue mt-1 mb-3 font-SemiBold">Commissioner Dashboard</h6>
