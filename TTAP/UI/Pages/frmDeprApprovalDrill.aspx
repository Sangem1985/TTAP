<%@ Page Title="" Language="C#" MasterPageFile="~/UI/UserMaster.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="frmDeprApprovalDrill.aspx.cs" Inherits="TTAP.UI.Pages.frmDeprApprovalDrill" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <ContentTemplate>
            <div id="content">
                        ...
                        <div class="widget-content nopadding">
                            <div class="row">
                                ...
                                <div class="col-sm-12 mb-3 d-flex">
                                    ...
                                    <%--<asp:Button Text="Export to Excel" CssClass="btn btn-blue ml-2 px-4 py-1 title5" ID="BtnExportExceleee" runat="server" OnClick="BtnExportExcel_Click" />--%>
                                        ...
                                        <Columns>
                                           ...
                                           <%-- <asp:BoundField DataField="ApplicationNumber" ItemStyle-HorizontalAlign="Center" HeaderText="Application Number">
                                             ...
                                             <asp:TemplateField HeaderText="Application Number" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <a href="#/" id="txt" onclick="javascript:GetIncentives(<%# Eval("IncentiveId") %>);"><%# Eval("ApplicationNumber") %></a>
                                                </ItemTemplate>
                                            ...
                                            <asp:BoundField DataField="NEFTRequestDate" ItemStyle-HorizontalAlign="Center" HeaderText="Submitted Date">
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:BoundField>
                                             <asp:BoundField DataField="Amount" ItemStyle-HorizontalAlign="Center" HeaderText="Amount Paid">
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:BoundField>
             ...
             <div class="masking" id="centreDetPopup" style="display: none;">
                ...
                <div class="clientpopup" style="width: 966px; height: 232px; margin-left: -475px; margin-top: -135px;">
    ...
    <script type="text/javascript">
        ...
        function Export() {
            $("[id*=gvdetailsnew]").table2excel({
                filename: "PaymentReceivedApplications.xls"
            });
        }
