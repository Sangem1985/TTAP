<%@ Page Title="" Language="C#" MasterPageFile="~/UI/UserMaster.Master" AutoEventWireup="true" CodeBehind="ReminderQueries.aspx.cs" Inherits="TTAP.UI.Pages.ReminderQueries" %>
                    ...
                    <div class="w-100 px-3 frm-form box-content py-3 font-medium title5">
                        ...
                        <div class="widget-content nopadding">
                            <div>
                                    ...
                                    <table>
                                        <div id="divSave" runat="server">
                                            <tr runat="server" id="tr1">
                                                ...
                                                <td>
                                                    <asp:Button Text="Send Reminder" CssClass="btn btn-blue ml-2 px-4 py-1 title5" ID="btnAdd" OnClick="btnAdd_Click" runat="server" />
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Button Text="Reject" Style="background: red;"
                                                        CssClass="btn btn-blue ml-2 px-4 py-1 title5" ID="btnReject" OnClick="btnReject_Click" runat="server" />
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
                                <div id="divGridReminder" runat="server" visible="false">
                                    <div class="col-sm-12 text-blue font-SemiBold mb-1">Previous Reminder Details</div>
                                    <asp:GridView ID="gvGridReminders" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                ...
                                <div id="divUserReminderGrid" runat="server" visible="false">
                                    <div class="col-sm-12 text-black font-SemiBold mb-1">Reminder Details</div>
                                    <asp:GridView ID="GVUserReminder" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                        CssClass="table table-bordered title6 alternet-table pro-detail w-100 NewEnterprise" EmptyDataText="No Data Found">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <HeaderStyle CssClass="GridviewScrollC1HeaderWrap" />
                                        <RowStyle CssClass="GridviewScrollC1Item" />
