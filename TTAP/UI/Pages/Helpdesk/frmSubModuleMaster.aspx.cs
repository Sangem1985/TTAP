...
namespace TTAP.UI
{
    public partial class frmSubModuleMaster : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    BindModuleDtls(ddlApplication.SelectedValue,ddlModule.SelectedValue);
                }
            }
            catch (Exception ex)
            {
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            try
            {
                if (ViewState["Module_Code"] == null)
                {
                    ViewState["Module_Code"] = "0";
                }
                ...
                else
                {
                    ...
                    objModuleVos.Module_Code = ViewState["Module_Code"].ToString();
                    ...
                    objModuleVos.SubModule = txtSubModule.Text.Trim().TrimStart();

                    string Validstatus = Objret.InseringSubModuleDetails(objModuleVos);
        ...
        public DataSet GetModuleDtls(string ApplicationID, string GroupID)
        {
            ...
            Dsnew = Objret.GenericFillDs("USP_GET_SUB_MODULE_DETAILS", pp);
            return Dsnew;
        }
        protected void BindModuleDtls(string ApplicationID, string GroupID)
        {
            try
            {
                DataSet dsnew = new DataSet();
                dsnew = GetModuleDtls(ApplicationID, GroupID);
        ...
        public string GeneralInformationcheck()
        {
            ...
            if (txtSubModule.Text.TrimStart().Trim() == "")
            {
                ErrorMsg = ErrorMsg + slno + ". Please Enter Sub Module \\n";
                slno = slno + 1;
            }
        ...
        protected void gvDetails_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Rowedit")
            {
                ...
                txtSubModule.Text = ((Label)(gr.FindControl("lblModule_Desc"))).Text;


                ViewState["MainModule_Code"] = ((Label)(gr.FindControl("lblModule_Code"))).Text;
                BtnSave.Text = "Update";
            }
            else if (e.CommandName == "RowDdelete")
            {
                ...
                objModuleVos.Module_Code = ((Label)(gr.FindControl("lblModule_Code"))).Text;
