...
namespace TTAP.UI
{
    public partial class HdDashBoardApproval : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    if (ObjLoginvo.userlevel == "2" && ObjLoginvo.Role_Code == "DO")
                    {
        ...
        public DataSet GetapplicationDtls(string USERID, string USERTYPE, string DistrictID, string Mandal_Id)
        {
            ...
            Dsnew = Objret.GenericFillDs("[USP_GET_DEPARTMENTAPPROVALDASHBOARD]", pp);
            return Dsnew;
        }
    }
}