<%@ Page Title="" Language="C#" MasterPageFile="~/UI/UserMaster.Master" AutoEventWireup="true" CodeBehind="frmdeptUserMaaping.aspx.cs" Inherits="TTAP.UI.frmdeptUserMaaping" %>
                            ...
                            <div class="widget-box">
                                ...
                                <div class="widget-content nopadding">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 form-group">
                                            <label class="control-label label-required" id="Label4" runat="server">Dept Users</label>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive mt-2">
                                            <asp:GridView ID="gvDetails" runat="server" CssClass="table table-bordered title6 alternet-table pro-detail w-100 NewEnterprise"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Dept User">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Ids" Visible="false">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:Label ID="lblintUserid" runat="server" Visible="false" Text='<%# Bind("intUserid") %>'></asp:Label>
                                                            <asp:Label ID="lblMappingID" runat="server" Visible="false" Text='<%# Bind("MappingID") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
