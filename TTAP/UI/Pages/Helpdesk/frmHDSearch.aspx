<%@ Page Title="" Language="C#" MasterPageFile="~/UI/UserMaster.Master" AutoEventWireup="true" CodeBehind="frmHDSearch.aspx.cs" Inherits="TTAP.UI.frmHDSearch" %>
            ...
            <div class="w-100 px-4 frm-form box-content py-4 font-medium title5 mt-sm-5">
                ...
                <div class="widget-content nopadding">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2 form-group">
                            <label class="control-label" id="Label2" runat="server">Status</label>
                            <asp:DropDownList ID="ddlStatus" runat="server" AutoPostBack="false" class="form-control">
                                <asp:ListItem Value="0">--All--</asp:ListItem>
                    ...
                    <div class="row">
                        <div class="col-sm-6 form-group">
                            <label class="control-label label-required">Reference No</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="inputGroupFileAddon01">HD</span>
                                </div>
                                <asp:TextBox ID="txtHdId" runat="server" Width="80px"
                                    MaxLength="10" onkeypress="return inputOnlyNumbers(event)" onblur="IsMobileNumber(this)" TabIndex="3"></asp:TextBox>
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="inputGroupFileAddon02">SUB</span>
                                </div>
                                <asp:TextBox ID="txtSubHdId" runat="server" Width="80px"
                                    MaxLength="10" onkeypress="return inputOnlyNumbers(event)" onblur="IsMobileNumber(this)" TabIndex="3"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-12 text-center mt-3">
                        <asp:Button ID="BtnSearch" runat="server" CssClass="btn btn-blue m-2" TabIndex="10" Text="Search" OnClick="BtnSearch_Click" />
                        <asp:Button ID="BtnClear" runat="server" CssClass="btn btn-success m-2" TabIndex="10" Text="Clear" />
                    </div>
