<%@ Page Title="" Language="C#" MasterPageFile="~/UI/UserMaster.Master" AutoEventWireup="true" CodeBehind="frmDLOApplicationsComm.aspx.cs" Inherits="TTAP.UI.Pages.frmDLOApplicationsComm" %>
                        ...
                        <div class="widget-content nopadding">
                            <div class="row">
                                ...
                                <div class="col-sm-12 mb-3 d-flex">
                                 ...
                                 <div class="col-sm-12 mb-3 d-center" align="center">
                                     <h6 id="Header" runat="server" style="color:red;font-weight: 700;">Applications</h6>
                                     </div>
                                    ...
                                    <asp:GridView ID="gvdetailsnew" runat="server" AllowPaging="false" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Address" ItemStyle-HorizontalAlign="Center" HeaderText="Address">
                                             ...
                                             <asp:BoundField DataField="SubmissionDate" ItemStyle-HorizontalAlign="Center" HeaderText="Applicant Submitted Date" DataFormatString="{0:dd-M-yyyy}">
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:BoundField>
                                             <asp:BoundField DataField="PaymentVerifiedDate" ItemStyle-HorizontalAlign="Center" HeaderText="Payment Verified Date" DataFormatString="{0:dd-M-yyyy}">
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="AdminVerifiedDate" ItemStyle-HorizontalAlign="Center" HeaderText="DLO Received Date" DataFormatString="{0:dd-M-yyyy}">
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="DayCount" ItemStyle-HorizontalAlign="Center" HeaderText="No of Days Pending with DLO">
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="InsScheduledDate" ItemStyle-HorizontalAlign="Center" HeaderText="Inspection Scheduled Date" DataFormatString="{0:dd-M-yyyy}">
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="InsDayCount" ItemStyle-HorizontalAlign="Center" HeaderText="No of Days Pending with DLO from Scheduled Date">
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="StageDescription" ItemStyle-HorizontalAlign="Center" HeaderText="Status">
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:BoundField>
