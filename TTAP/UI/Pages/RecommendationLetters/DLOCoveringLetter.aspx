<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DLOCoveringLetter.aspx.cs" Inherits="TTAP.UI.Pages.RecommendationLetters.DLOCoveringLetter" %>
...
<head runat="server">
    ...
    <link href="../../../css/bootstrap.min.css" rel="stylesheet" />
    <title>DLO Covering Letter</title>
    <style type="text/css">
        .leftalign {
            text-align: left;
        }
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                        <span style="float: right;"><span style="float: left;"><b>To</b></span>
                            <br />
                            The Commissioner of Handlooms <br />and Textiles and AEPs,<br />
