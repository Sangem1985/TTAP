...
{
    public partial class frmIPOApplications : System.Web.UI.Page
    {
        ...
        public void BindApplicationData()
        {
            ...
            dss = GetIPOApplications(Convert.ToInt32(Session["DistrictId"].ToString()), Stg, txtsearch.Text.Trim().TrimStart(), Session["uid"].ToString());
        ...
        public DataSet GetIPOApplications(int DistId, int StageId, string UnitName, string UserId)
        {
            ...
            Dsnew = caf.GenericFillDs("USP_GET_IPO_APPLICATIONS_DTLS", pp);
