...
{
    public partial class frmCapitalAssistanceExistingAnnexure : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Request.QueryString["IncentiveID"] != null)
            {
                ...
                GetIncetiveAttachements(IncentiveID, "N", "19");
            }
        }
        ...
        public void BindControls(string UserId, string IncentiveID)
        {
            ...
            if (dsData.Tables.Count > 0)
            {
                ...
                {
                    lblCurrentClaimAmount.InnerHtml = dsData.Tables[0].Rows[0]["CurrentClaim"].ToString();

                    BindPandMGrid(0, Convert.ToInt32(IncentiveID));
                    BindPMPaymentDtls(IncentiveID, "2");
                    ...
                    txtNewTechnologiesfortextileprocessing.InnerHtml = dsData.Tables[0].Rows[0]["NewTechnologiesfortextileprocessing"].ToString();
        ...
        public DataSet GetPMPaymentDtls(string INCENTIVEID, string TransType)
        {
            ...
            Dsnew = caf.GenericFillDs("USP_GET_PMPAYMENT_DTLS", pp);
            return Dsnew;
        }
