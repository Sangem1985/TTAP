<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmRentalLeaseSubsidyAnnexure.aspx.cs" Inherits="TTAP.UI.Pages.Annexures.frmRentalLeaseSubsidyAnnexure" %>
                        ...
                        <div class="row-fluid">
                            <div class="widget-box">
                                <div class="widget-title">
                                    ...
                                    <div class="row">
                                        <h3 class="text-black mb-3 col font-SemiBold text-center" runat="server" id="h3heading">Form – XIII : Rental / Lease Subsidy for Built up Space</h3>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-sm-12 table-responsive">
                                            <table class="table table-bordered title6  w-100 NewEnterprise">
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left">
                                                        <label class="control-label" runat="server" id="ddlTypeOfUse"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">9</td>
                                                    <td align="left" id="lblProductionPersonsTrained" runat="server">Production/Persons Trained</td>
                                                    <td align="left">
                                                        <label class="control-label" runat="server" id="txtProductionPersonsTrained"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left">Whether the unit is located in the Textile /Apparel Park declared by the Government of Telangana</td>
                                                    <td align="left">
                                                        <label class="control-label" id="RbtnTextileOrApparelArea" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">12</td>
                                                    <td align="left">Whether the Rental / Lease deed is registered</td>
                                                    <td align="left">
                                                        <label class="control-label" id="RbtnRentalLeasedeed" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">13</td>
                                                    <td align="left">Deed Number</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtDeedNumber" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">14</td>
                                                    <td align="left">Deed Date</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtDeedDate" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">15</td>
                                                    <td align="left">Rental Information</td>
                                                    <td align="left">
                                                        <asp:CheckBoxList ID="chkRentalInformationType" runat="server" Enabled="false" CssClass="checkbox" RepeatDirection="Vertical">
                                                        ...
                                                        <br />
                                                        <label class="control-label" id="txtOtherLeasingArrangement" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">16</td>
                                                    <td align="left">Built up space occupied by the Industry/Enterprise in the Textile /Apparel park ( in Sq Meters</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtBuiltUpSpaceOccupied" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">17</td>
                                                    <td align="left">Rent/Lease Amount (per Sq Meter)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtRentLeaseAmountPerSqMtr" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">18</td>
                                                    <td align="left">Total Monthly net rent</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtTotalMonthlyNetRent" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">19</td>
                                                    <td align="left" colspan="2">
                                                        <h6 class="text-black font-SemiBold" style="font-size: small;">Period of Lease (Regd. Lease Deed for Min. period of 10 years )</h6>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    ...
                                                    <td align="left">
                                                        <label class="control-label" id="txtPeriodofLeaseFromDate" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    ...
                                                    <td align="left">
                                                        <label class="control-label" id="txtPeriodofLeaseToDate" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">20</td>
                                                    <td align="left">Any other subsidy from another source
                                                    </td>
                                                    <td align="left">
                                                        <label class="control-label" id="RbtnIsAnyothersubsidy" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2" id="othersubsidy1" runat="server" visible="false">
                                                    <td align="center"></td>
                                                    <td align="left">Source</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtSubsidySource" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2" id="othersubsidy2" runat="server" visible="false">
                                                    <td align="center"></td>
                                                    <td align="left">Amount</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtSubsidySourceAmount" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <div class="row" id="Div1" runat="server">
                                                            <div class="col-sm-12 text-black font-SemiBold mb-1">Rental Subsidy reimbursement already availed by Enterprise from the Date of Commencement of Production</div>
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive mt-2">
                                                                <asp:GridView ID="grdSGSTReimbursement" runat="server" CssClass="table table-bordered title6 pro-detail w-100 NewEnterprise"
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left">Claim Application submitted by the Enterprise/Industry for the 1st half Year/2nd half year</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtClaimApplicationsubmitted" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <%--<tr class="GridviewScrollC1Item2">
                                                    <td align="center">23</td>
                                                    <td align="left">Period of claim amount</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtFromDateOfClaimAmount" runat="server"></label>
                                                    </td>
                                                </tr>--%>
                                                <tr>
                                                    <td align="center">23</td>
                                                    <td colspan="2">
                                                        <div class="row" id="Div2" runat="server">
                                                            <div class="col-sm-12 text-black font-SemiBold mb-1">Period of claim amount</div>
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive mt-2">
                                                                <asp:GridView ID="grdSGSTReimbursementClaim" runat="server" CssClass="table table-bordered title6 pro-detail w-100 NewEnterprise"
                                                                    AutoGenerateColumns="false">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <HeaderStyle CssClass="GridviewScrollC1HeaderWrap" />
                                                                    <RowStyle CssClass="GridviewScrollC1Item" />
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left">Reimbursement Amount claimed by the Industry/Enterprise (In Rupees) (25 % of the net rent value  per the first five years of operation period)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtReimbursementAmountClaimed" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                ...
                                                <tr>
                                                    <td colspan="3">
                                                        <div class="col-sm-12 py-4">
                                                            <b>Note : </b>** Half year means every 6 months from the financial year beginning from 1st April to 31st March.
                                                           <br />
                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                                            1). If any further information/documents required by the department, the same shall be furnished by the entrepreneur.
                                                            <br />
                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
