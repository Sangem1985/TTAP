...
{
    public partial class frmReimbursementofLandCost : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Request.QueryString["IncentiveID"] != null)
            {
                ...
                GetLandCostSubsidy("0", IncentiveID);
                GetIncetiveAttachements(IncentiveID, "N", "11");
            }
        }
        ...
        public void GetLandCostSubsidy(string uid, string IncentiveID)
        {
            try
            {
                ...
                if (ds.Tables[0].Rows.Count > 0 && ds.Tables[0].Rows.ToString() != "" && ds.Tables[0].Rows.ToString() != null)
                {
                    ...
                    RbtnTexttileLocationTS.InnerHtml = ds.Tables[0].Rows[0]["TexttileLocationTSText"].ToString();
                    ...
                    txtTotalPlinthArea.InnerHtml = ds.Tables[0].Rows[0]["TotalPlinthArea"].ToString();
                    txtTotalExtentOfLandPurchased.InnerHtml = ds.Tables[0].Rows[0]["TotalExtentOfLandPurchased"].ToString();
                    txtRatePerAcre.InnerHtml = ds.Tables[0].Rows[0]["RatePerAcre"].ToString();
                    txtTotalInvestmentinLand.InnerHtml = ds.Tables[0].Rows[0]["TotalInvestmentinLand"].ToString();
                    txtAmountAvailed.InnerHtml = ds.Tables[0].Rows[0]["AmountAvailed"].ToString();
                    txtSource.InnerHtml = ds.Tables[0].Rows[0]["Source"].ToString();
                    txtDateAvailed.InnerHtml = ds.Tables[0].Rows[0]["DateAvailed"].ToString();
