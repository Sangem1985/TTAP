<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmAssistanceforEnergyWaterEnvironmentalAnnexure.aspx.cs" Inherits="TTAP.UI.Pages.Annexures.frmAssistanceforEnergyWaterEnvironmentalAnnexure" %>
                        ...
                        <div class="row-fluid">
                            <div class="widget-box">
                                <div class="widget-title">
                                    ...
                                    <div class="row">
                                        <h3 class="text-black mb-3 col font-SemiBold text-center" runat="server" id="h3heading">Form – VIII : Assistance for Energy, Water and Environmental Compliance to Existing Units</h3>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-sm-12 table-responsive">
                                            <table class="table table-bordered title6  w-100 NewEnterprise">
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left">Is the Unit into Commercial Production for at least three years</td>
                                                    <td align="left">
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left">Type of Infrastructure Installed</td>
                                                    <td align="left">
                                                        <asp:CheckBoxList ID="chkTypeofInfrastructure" runat="server" Enabled="false" CssClass="checkbox" RepeatDirection="Vertical">
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left">Assistance Required For</td>
                                                    <td align="left">
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left" colspan="2">
                                                        <h6 class="text-black font-SemiBold">Energy Audit Conducted</h6>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">Date of Audit</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtEnergyAuditDateofAudit" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">Name of Auditor / Audit Firm</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtEnergyAuditNameofAuditorAuditFirm" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">Cost Incurred (In Rupees)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtEnergyAuditCostIncurred" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">Invoice Number with Date of Invoice</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtEnergyAuditInvoiceNumber" runat="server"></label>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left" colspan="2">
                                                        <h6 class="text-black font-SemiBold">Water Audit Conducted</h6>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">Date of Audit</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtWaterDateofAudit" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">Name of Auditor / Audit Firm</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtWaterNameofAuditorAuditFirm" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">Cost Incurred (In Rupees)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtWaterCostIncurred" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">Invoice Number with Date of Invoice</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtWaterInvoiceNumber" runat="server"></label>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left" colspan="2">
                                                        <h6 class="text-black font-SemiBold">Environmental Compliance</h6>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">Date of Receipt of Compliance</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtEnvironmentalComplianceDateofAudit" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">Name of Compliance</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtNameofCompliance" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">Certifying Agency</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtCertifyingAgency" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">Cost Incurred (In Rupees)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtEnvironmentalComplianceCostIncurred" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">Invoice Number with Date of Invoice</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtEnvironmentalComplianceInvoiceNumber" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">15</td>
                                                    <td align="left" colspan="2">
                                                        <h6 class="text-black font-SemiBold">Claims Made So far</h6>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">Date of Last Claim</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtDateofLastClaim" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">Nature of Expenses</td>
                                                    <td align="left">
                                                        <asp:CheckBoxList ID="chkNatureofExpenses" runat="server" CssClass="checkbox" Enabled="false" RepeatDirection="Vertical">
                                                            <asp:ListItem Text="Energy Audit" Value="1"></asp:ListItem>
                                                            <asp:ListItem Text="Water Audit" Value="2"></asp:ListItem>
                                                            <asp:ListItem Text="Environmental Compliance" Value="3"></asp:ListItem>
                                                            <%--<asp:ListItem Text=" Common Effluent Treatment Plant at Cluster / Industrial Park" Value="4"></asp:ListItem>--%>
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">Claim Amount (In Rupees)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtClaimAmount" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">Reimbursement Received (In Rupees)</td>
                                                    <td align="left">
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left" colspan="2">
                                                        <h6 class="text-black font-SemiBold">Government Scheme Availed</h6>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">Amount Availed  (In Rupees)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtGovernmentAmountAvailed" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    ...
                                                    <td align="left">
                                                        <label class="control-label" id="txtGovernmentDateAvailed" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">17</td>
                                                    <td align="left" colspan="2">
                                                        <h6 class="text-black font-SemiBold">Current Claim (In Rupees) - (50% limited to Rs 50,000 for each category)</h6>
                                                    </td>
                                                </tr>

                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">Energy Audit</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtCurrentClaimEnergyAudit" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">Water Audit</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtCurrentClaimWaterAudit" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">Environmental Compliance</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtCurrentClaimEnvironmentalCompliance" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
