<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmStampDutyReimbursementAnnexure.aspx.cs" Inherits="TTAP.UI.Pages.Annexures.frmStampDutyReimbursementAnnexure" %>
                        ...
                        <div class="row-fluid">
                            <div class="widget-box">
                                <div class="widget-title">
                                    ...
                                    <div class="row">
                                        <h3 class="text-black mb-3 col font-SemiBold text-center" runat="server" id="h3heading">Form – VI : Reimbursement Of Stamp Duty, Transfer duty, Mortgage & Hypothecation Duty</h3>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-sm-12 table-responsive">
                                            <table class="table table-bordered title6  w-100 NewEnterprise">
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left">Line of Activity</td>
                                                    <td align="left">
                                                        <label class="control-label" runat="server" id="txtLineofActivity"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">9</td>
                                                    <td align="left">Nature of Asset</td>
                                                    <td align="left">
                                                        <label class="control-label" id="ddlNatureofAsset" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">10</td>
                                                    <td align="left">Land Purchased – As per the Registered Sale Deed (In sq mtrs)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtLandPurchased" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">11</td>
                                                    <td align="left">Land Purchased Cost Per Sq mtr</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtLandPurchasedCostPersqmtrs" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">12</td>
                                                    <td align="left">Plinth Area of the Building – As per the Approved Building Plan by HUDA / DT & CP / IALA (In sq mtrs)
                                                    </td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtPlinthAreaoftheBuilding" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">13</td>
                                                    <td align="left">5 times of the Plinth Area of Factory Buildings (In sq mtrs)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtPlinthFactoryBuildings" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">14</td>
                                                    <td align="left">Area required for the Factory as per the appraisal (In sq mtrs)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtFactoryappraisal" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">15</td>
                                                    <td align="left">Area required for the Factory as per the norms of TSPCB or any other State Government Department (In sq mtrs)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtTSPCB" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">16</td>
                                                    <td align="left">Nature of Transaction / Deed Registered for Industrial Use (Sale / Lease or Lease-cum-sale Transfer Deed / Financial Deeds and Mortgages etc)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="ddlNatureofTransaction" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left">
                                                        <label class="control-label" id="txtDateofRegistration" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">18</td>
                                                    <td align="left">Name of Sub-Registrar Office, where registered</td>
                                                    <td align="left">
                                                        <label class="control-label" id="SubRegistrar" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">19</td>
                                                    <td align="left" colspan="2">
                                                        <h6 class="font-SemiBold">Stamp Duty/Transfer duty / Mortgage and Hypothecations Duty / Land Conversion Charges & Land cost in IE/IDA/IP’s Paid</h6>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">Stamp Duty / Transfer Duty Paid (In Rs)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtStampDutyTransferDutyPaid" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">Mortgage & Hypothecation Duty Paid (In Rs)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtMortgageHypothecationDutyPaid" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">20</td>
                                                    <td align="left">Stamp Duty Exemption already Availed as per GO. Ms. No. 59</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtStampDutyExemptionalreadyAvailed" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">21</td>
                                                    <td align="left">Details of the Term loan(s) availed with respect to 16 above</td>
                                                    <td align="left">
                                                        <label class="control-label" id="Termloan14" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">22</td>
                                                    <td align="left" colspan="2">
                                                        <h6 class="text-black font-SemiBold mb-1" style="font-size: small;">Details of Land Subsidy Sanctioned / Availed (If Any)</h6>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left" colspan="2">
                                                        <h6 class="font-SemiBold">Current Claim (100% Reimbursement)</h6>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">Stamp Duty / Transfer Duty (In Rs)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtCurrentClaimStampTransferDuty" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">Mortgage & Hypothecation Duty (In Rs)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtCurrentClaimMortgageHypothecationDuty" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
