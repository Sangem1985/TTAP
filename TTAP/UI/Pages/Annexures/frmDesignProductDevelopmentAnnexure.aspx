<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmDesignProductDevelopmentAnnexure.aspx.cs" Inherits="TTAP.UI.Pages.Annexures.frmDesignProductDevelopmentAnnexure" %>
                        ...
                        <div class="row-fluid">
                            <div class="widget-box">
                                <div class="widget-title">
                                    ...
                                    <div class="row">
                                        <h3 class="text-black mb-3 col font-SemiBold text-center" runat="server" id="h3heading">Form – XI: Design, Product Development and Diversification</h3>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-sm-12 table-responsive">
                                            <table class="table table-bordered title6  w-100 NewEnterprise">
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left">New Product / Design Developed / Diversification (not applicable for generic products)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtDesignDeveloped" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">9</td>
                                                    <td align="left">Expenditure Incurred in New Product/ Design Development / Diversification</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtExpenditureIncurred" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">10</td>
                                                    <td align="left">Earlier Claims made for New Product / Design Development / Diversification</td>
                                                    <td align="left">
                                                        <label class="control-label" id="RbtnEarlierClaimsMade" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    ...
                                                    <td align="left">
                                                        <label class="control-label" id="txtEarlierCliamYear" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">amount claimed (In Rupees)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtamountclaimed" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">11</td>
                                                    <td align="left">Current Claim (In Rupees) (20% of the annual expenditure limited to Rs 2 lakhs)</td>
                                                    <td align="left">
