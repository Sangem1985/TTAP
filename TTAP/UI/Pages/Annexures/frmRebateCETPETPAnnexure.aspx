<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmRebateCETPETPAnnexure.aspx.cs" Inherits="TTAP.UI.Pages.Annexures.frmRebateCETPETPAnnexure" %>
                        ...
                        <div class="row-fluid">
                            <div class="widget-box">
                                <div class="widget-title">
                                    ...
                                    <div class="row">
                                        <h3 class="text-black mb-3 col font-SemiBold text-center" runat="server" id="h3heading">Form – XV : Rebate in O&M Charges for CETP /ETP (Environment Infrastructure)</h3>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-sm-12 table-responsive">
                                            <table class="table table-bordered title6  w-100 NewEnterprise">
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left">Approved Project Cost (In Rs) -CETP/ETP</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtApprovedProjectCost" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">9</td>
                                                    <td align="left">Actual Cost Invested (In Rs)-CETP/ETP</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtActualCostInvested" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">10</td>
                                                    <td align="left">Utilization of ETP/CETP</td>
                                                    <td align="left">
                                                        <label class="control-label" id="ddlUtilizationETPCETP" runat="server"></label>
                                                    </td>
                                                </tr>

                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">11</td>
                                                    <td align="left">Type of Effluent Treatment Plant (ETP)/Common Effluent Treatment Plant (CETP)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="RbtnTypeofETP" runat="server"></label>
                                                        <br />
                                                        <label class="control-label" id="txtOtherETP" runat="server"></label>
                                                    </td>
                                                </tr>

                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">12</td>
                                                    <td align="left">Details of the CETP/ETP -O&M Operator/Agency/Firm</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtCETPETPDetails" runat="server"></label>
                                                    </td>
                                                </tr>

                                                <tr class="GridviewScrollC1Item2" id="divcommon1" runat="server">
                                                    <td align="center">13</td>
                                                    <td align="left">Captive or Common ETP</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtCaptiveCommonETP" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2" id="divcommon2" runat="server">
                                                    <td align="center"></td>
                                                    <td align="left">Cost of the ETP</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtETPCost" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2" id="divcommon3" runat="server">
                                                    <td align="center"></td>
                                                    <td align="left">Rebate Claimed (50% of the cost with CAP of Rs. 10.00 Cr.)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtRebateClaimed" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2" id="divcommon4" runat="server">
                                                    <td align="center">14</td>
                                                    <td align="left">Year of the Claim</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtYearoftheClaim" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2" id="divcommon5" runat="server">
                                                    <td align="center">15</td>
                                                    <td align="left">Government (State, Central, Govt Agency, Financial Institution) Constructed or SPV</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtAnyGovtAgency" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2" id="divcommon6" runat="server">
                                                    <td align="center">16</td>
                                                    <td align="left">Years of Commercial Production</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtYearsCommercialProduction" runat="server"></label>
                                                    </td>
                                                </tr>

                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center" id="td15" runat="server">17</td>
                                                    <td align="left">Commencement of Commercial Operation of Industry/Enterprise</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtCommencementCommercialOperation" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center" id="td16" runat="server">18</td>
                                                    <td align="left">Date of Commencement of Utilization of CETP/ETP</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtDateofCommencementUtilization" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="center" id="td17" runat="server">19</td>
                                                    <td colspan="2">
                                                        <div class="row" id="Div1" runat="server">
                                                            <div class="col-sm-12 text-black font-SemiBold mb-1">Details of Effluent Treatment Charges(O&M charges) during last 6 months(half year)</div>
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive mt-2">
                                                                <asp:GridView ID="grdETPDetails" runat="server" CssClass="table table-bordered title6 pro-detail w-100 NewEnterprise"
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left" colspan="2">
                                                        <h6 class="text-black font-SemiBold mb-1" style="font-size: small;">Any Other Subsidy from Another Source, if any</h6>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left">
                                                        <label class="control-label" id="txtSource" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center" id="td18" runat="server">21</td>
                                                    <td align="left">Current Claim (In Rupees) (Rebate in the O&M Charges in the following scale: Year 1 and 2 – 75%, Year 3 and 4 – 50%, Year 5 – 25%)</td>
                                                    <td align="left">
