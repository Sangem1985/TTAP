<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmWorkerHousingDormitoriesAnnexure.aspx.cs" Inherits="TTAP.UI.Pages.Annexures.frmWorkerHousingDormitoriesAnnexure" %>
                        ...
                        <div class="row-fluid">
                            <div class="widget-box">
                                <div class="widget-title">
                                    ...
                                    <div class="row">
                                        <h3 class="text-black mb-3 col font-SemiBold text-center" runat="server" id="h3heading">Form – XVI : Assistance for Development of Worker Housing / Dormitories</h3>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-sm-12 table-responsive">
                                            <table class="table table-bordered title6  w-100 NewEnterprise">
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left">Location of the Worker Housing /Dormitory</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtWorkerHousingLocation" runat="server"></label>
                                                    </td>
                                                </tr>

                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">10</td>
                                                    <td align="left">Land purchased (in Sq. Mtrs.)</td>
                                                    <td align="left">
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left">Plinth Area of the Buildin for Worker Housing/Dormitory (in Sq. Mtrs.)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtBuildingPlinthArea" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">12</td>
                                                    <td align="left">Area required for the Building for Worker Housing/Dormitory as per the appraisal (in Sq. Mtrs.)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtBuildingAreaRequired" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">13</td>
                                                    <td align="left">Investment in the land used for ( Worker Housing /Dormitory) (Amount in Rupees)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtLandInvestment" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">14</td>
                                                    <td align="left">In case of Land Conversion Charges(Amount in Rupees)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtLandConversionCharges" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">15</td>
                                                    <td align="left">In case of lands purchased in IE/IDA/IP’s cost of land(Amount in Rupees)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtPurchasedLandCost" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">16</td>
                                                    <td align="left">Total Occupants load for Worker Housing/Dormitory</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtHousingOccupantsLoad" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">17</td>
                                                    <td align="left">Occupancy rate in the Worker Housing /Dormitory (%)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtOccupancyRate" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">18</td>
                                                    <td align="left">Start Date of usage of Workers Quarters</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtQuartersStartDate" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">19</td>
                                                    <td align="left">End Date of usage of Workers Quarters</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtQuartersEndDate" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left">Total land used for worker housing(in acre)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtTotallandusedworker" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">22</td>
                                                    <td align="left">Land purchased rate per acre(In Rs)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtLandpurchasedrateper" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">23</td>
                                                    <td align="left">Current Claim  (In Rs) (60% of the land cost and land conversion charges with an upper limit of Rs 30 lakhs per acre)</td>
                                                    <td align="left">
