<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmPowerTariffSubsidyAnnexure.aspx.cs" Inherits="TTAP.UI.Pages.Annexures.frmPowerTariffSubsidyAnnexure" %>
                        ...
                        <div class="row-fluid">
                            <div class="widget-box">
                                <div class="widget-title">
                                    ...
                                    <div class="row">
                                        <h3 class="text-black mb-3 col font-SemiBold text-center" runat="server" id="h3heading">Form – V : Reimbursement of Power Consumption Charges</h3>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-sm-12 table-responsive">
                                            <table class="table table-bordered title6  w-100 NewEnterprise">
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left">Existing Power Connection in KVA (base)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtExistingPower" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">10</td>
                                                    <td align="left">New Power Connection in KVA</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtNewPower" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">11</td>
                                                    <td align="left">Date of New Power Connection Released
                                                    </td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtDateofNewpower" runat="server"></label>
                                                    </td>
                                                </tr>

                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">12</td>
                                                    <td align="left">Total No. of Power connections including Industry, colonies, Residential & street/parks etc
                                                    </td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtTotalPowerconnections" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">13</td>
                                                    <td align="left">No. of Power connections exclusively for Industry use
                                                    </td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtIndustryPowerconnections" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <div class="row" id="Div1" runat="server">
                                                            <div class="col-sm-12 text-black font-SemiBold mb-1">Power utilized during previous three financial years before this expansion/ diversification project</div>
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive mt-2">
                                                                <asp:GridView ID="grdPowerutilized" runat="server" CssClass="table table-bordered title6 pro-detail w-100 NewEnterprise"
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <div class="row" id="Div2" runat="server">
                                                            <div class="col-sm-12 text-black font-SemiBold mb-1">Details of Energy consumed from the date of commencement of production and amount claimed for the Half year</div>
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive mt-2">
                                                                <asp:GridView ID="grdEnergyConsumed" runat="server" CssClass="table table-bordered title6 pro-detail w-100 NewEnterprise"
                                                                    AutoGenerateColumns="false">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <HeaderStyle CssClass="GridviewScrollC1HeaderWrap" />
                                                                    <RowStyle CssClass="GridviewScrollC1Item" />
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left">Current Claim Period</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtCurrentClaimPeriodfrom" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">17</td>
                                                    <td align="left">Current Claim Amount (In Rupees)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtCurrentClaimAmount" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
