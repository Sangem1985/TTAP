<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmConcessiononSGSTAnnexure.aspx.cs" Inherits="TTAP.UI.Pages.Annexures.frmConcessiononSGSTAnnexure" %>
                        ...
                        <div class="row-fluid">
                            <div class="widget-box">
                                <div class="widget-title">
                                    ...
                                    <div class="row">
                                        <h3 class="text-black mb-3 col font-SemiBold text-center" runat="server" id="h3heading">Form – VII : Reimbursement of Tax</h3>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-sm-12 table-responsive">
                                            <table class="table table-bordered title6  w-100 NewEnterprise">
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left">GST Identification Number</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtGSTIdentificationNumber" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left">Installed capacity of th existing Enterprise as certified by the financial institution/ chartered accountant</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtInstalledcapacity" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                            ...
                                                            <div class="col-sm-10 table-responsive">
                                                                <table class="table table-bordered title6 w-100 NewEnterprise">
                                                                    ...
                                                                    <tr class="GridviewScrollC1Item">
                                                                        ...
                                                                        <td align="center">
                                                                            <label id="lblApprovedProjectCostLand" runat="server" cssclass="control-label"></label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr class="GridviewScrollC1Item2">
                                                                        <td>2</td>
                                                                        ...
                                                                        <td align="center">
                                                                            <label id="lblApprovedProjectCostBuilding" runat="server" cssclass="control-label"></label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr class="GridviewScrollC1Item">
                                                                        <td>3</td>
                                                                        ...
                                                                        <td align="center">
                                                                            <label id="lblApprovedProjectCostPlantMachinery" runat="server" cssclass="control-label"></label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td></td>
                                                                        ...
                                                                        <td id="Td1" runat="server" align="center">
                                                                            <label id="lblApprovedProjectCostTotal" runat="server" font-bold="True"></label>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <div class="row" id="Div1" runat="server">
                                                            <div class="col-sm-12 text-black font-SemiBold mb-1">Production details preceding three years before expansion/diversification project as certified by the financial institution/ chartered accountant</div>
                                                            <div class="col-sm-10 table-responsive">
                                                                <table class="table table-bordered title6 w-100 NewEnterprise">
                                                                    <tr align="center" class="GridviewScrollC1HeaderWrap">
                                                                        <th>Sl.No</th>
                                                                    ...
                                                                    <tr class="GridviewScrollC1Item">
                                                                        <td>1</td>
                                                                        <td align="center">
                                                                            <label class="control-label" id="txtYear1" runat="server"></label>
                                                                        </td>
                                                                        <td align="center">
                                                                            <label class="control-label" id="txtEnterprises1" runat="server"></label>
                                                                        </td>
                                                                        <td align="center">
                                                                            <label class="control-label" id="txtTotalProduction1" runat="server"></label>
                                                                        </td>
                                                                        <td align="center">
                                                                            <label class="control-label" id="txtTaxPaid1" runat="server"></label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr class="GridviewScrollC1Item2">
                                                                        <td>2</td>
                                                                        ...
                                                                        <td align="center">
                                                                            <label class="control-label" id="txtYear2" runat="server"></label>
                                                                        </td>
                                                                        <td align="center">
                                                                            <label class="control-label" id="txtEnterprises2" runat="server"></label>
                                                                        </td>
                                                                        <td align="center">
                                                                            <label class="control-label" id="txtTotalProduction2" runat="server"></label>
                                                                        </td>
                                                                        <td align="center">
                                                                            <label class="control-label" id="txtTaxPaid2" runat="server"></label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr class="GridviewScrollC1Item">
                                                                        <td>3</td>
                                                                        ...
                                                                        <td align="center">
                                                                            <label class="control-label" id="txtYear3" runat="server"></label>
                                                                        </td>
                                                                        <td align="center">
                                                                            <label class="control-label" id="txtEnterprises3" runat="server"></label>
                                                                        </td>
                                                                        <td align="center">
                                                                            <label class="control-label" id="txtTotalProduction3" runat="server"></label>
                                                                        </td>
                                                                        <td align="center">
                                                                            <label class="control-label" id="txtTaxPaid3" runat="server"></label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr class="GridviewScrollC1Item font-bold">
                                                                        <td>3</td>
                                                                        <td align="center">
                                                                            <label class="control-label" id="Label1" runat="server">Total</label>
                                                                        </td>
                                                                        <td align="center">
                                                                            <label class="control-label" id="txtEnterprisesTotal" runat="server"></label>
                                                                        </td>
                                                                        <td align="center">
                                                                            <label class="control-label" id="txtTotalProductionTotal" runat="server"></label>
                                                                        </td>
                                                                        <td align="center">
                                                                            <label class="control-label" id="txtTaxPaidTotal" runat="server"></label>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <div class="row" id="Div4" runat="server">
                                                            <div class="col-sm-12 text-black font-SemiBold mb-1">Sales Details</div>
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive mt-2">
                                                                <asp:GridView ID="gvsalesDetails" runat="server" CssClass="table table-bordered title6 pro-detail w-100 NewEnterprise"
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <div class="row" id="Div2" runat="server">
                                                            <div class="col-sm-12 text-black font-SemiBold mb-1">SGST reimbursement already availed by Enterprise from the Date of Commencement of Production (Maximum for 7 years)</div>
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive mt-2">
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left">Moratorium Period</td>
                                                    <td align="left">
                                                        <label class="control-label" id="lblMoratoriumPeriod" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">16</td>
                                                    <td align="left">Claim Application submitted by the Enterprise/Industry for the 1st Half Yare/2nd Half Year</td>
                                                    <td align="left">
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left">Tax paid by the Enterprise during the 1st Half Year/2nd half year as certified by the Commercial Tax Department</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtTaxpaid" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">18</td>
                                                    <td align="left">Current Claim (In Rs)</td>
                                                    <td align="left">
