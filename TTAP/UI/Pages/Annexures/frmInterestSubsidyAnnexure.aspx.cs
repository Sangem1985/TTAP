...
{
    public partial class frmInterestSubsidyAnnexure : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Request.QueryString["IncentiveID"] != null)
            {
                ...
                if (Convert.ToInt32(IncentiveID) > 41237)
                {
                    Response.Redirect("frmInterestSubsidyAnnexureNew.aspx?IncentiveID="+ IncentiveID);
                    return;
                }
        ...
        public void BindInterestSubsidy(string uid, int IncentiveID)
        {
            ...
            try
            {
                ...
                if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    if (ds.Tables[0].Rows[0]["SanctionOrderNo"].ToString() == "" || ds.Tables[0].Rows[0]["SanctionOrderNo"].ToString() == null)
                    {
                        lblAgency.Text = "No";
