<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmTrainingSubsidyAnnexure.aspx.cs" Inherits="TTAP.UI.Pages.Annexures.frmTrainingSubsidyAnnexure" %>
                        ...
                        <div class="row-fluid">
                            <div class="widget-box">
                                <div class="widget-title">
                                    ...
                                    <div class="row">
                                        <h3 class="text-black mb-3 col font-SemiBold text-center" runat="server" id="h3heading">Form XVII : Reimbursement of Cost in Skill Up Gradation and Training</h3>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-sm-12 table-responsive">
                                            <table class="table table-bordered title6  w-100 NewEnterprise">
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left">Name of the skill development Programme (new skills or upgradation)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtSkillName" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">10</td>
                                                    <td align="left">Name of the training institute & duration (Empanelled by the DH&T department)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtTrainingInstituteName" runat="server"></label>
                                                    </td>
                                                </tr>

                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">11</td>
                                                    <td align="left">No of employees trained by the establishment</td>
                                                    <td align="left">
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left">Expenditure incurred for training Programme per employee (In Rupees)</td>
                                                    <td align="left">
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left">Months of employment in the Organization</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtMonthsEmployment" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left">Current Claim (In Rupees) (Reimbursement of Rs 3000 per employee for company employing less than 1000 and Rs 5000 per employee for company employing more than 1000 employees)</td>
                                                    <td align="left">
