<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmOtherInfrastructureSupportAnnexure.aspx.cs" Inherits="TTAP.UI.Pages.Annexures.frmOtherInfrastructureSupportAnnexure" %>
                        ...
                        <div class="row-fluid">
                            <div class="widget-box">
                                <div class="widget-title">
                                    ...
                                    <div class="row">
                                        <h3 class="text-black mb-3 col font-SemiBold text-center" runat="server" id="h3heading">Form – XIV : Other Infrastructure Support</h3>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-sm-12 table-responsive">
                                            <table class="table table-bordered title6  w-100 NewEnterprise">
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left">Whether it is located in Industrial Area declared by the Government</td>
                                                    <td align="left">
                                                        <label class="control-label" id="RbtnIndustrialArea" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">9</td>
                                                    <td align="left">Category of Business</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtCategoryofBusiness" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">10</td>
                                                    <td align="left">Years of Operation from Date of Commencement</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtYearsofOperation" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">11</td>
                                                    <td align="left">Justification for the location of Enterprise/Industry, if it is located outside the Industrial Area declared by the Government
                                                        (Location beyond 10 KM from existing IE / IDS)
                                                    </td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtJustificationforlocation" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">12</td>
                                                    <td align="left">Source of Finance</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtSourceOfFinance" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">13</td>
                                                    <td align="left" colspan="2">
                                                        <h6 class="text-black font-SemiBold">Description of the infrastructure facilities required and its objective</h6>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">Roads, Power, Water</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtRoadsPowerWaterDescription" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">Support Infrastructure</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtSupportInfrastructureDescription" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">14</td>
                                                    <td align="left">How the proposed infrastructure is critical to the Industrial Enterprise.</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtProposedInfrastructureJustification" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">15</td>
                                                    <td align="left" colspan="2">
                                                        <h6 class="text-black font-SemiBold">Estimate Cost of Infrastructure facilities (Total, Roads, Power, Water, Drainage Line)</h6>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    ...
                                                    <td align="left">
                                                        <label class="control-label" id="txtSupportEstimateCost" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    ...
                                                    <td align="left">
                                                        <label class="control-label" id="txtEstimateCostRoadsPowerWater" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    ...
                                                    <td align="left">
                                                        <label class="control-label" id="txtEstimateCostPower" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    ...
                                                    <td align="left">
                                                        <label class="control-label" id="txtEstimateCostWater" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">Drainage Line</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtEstimateCostDrainageLine" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">16</td>
                                                    <td align="left">Name of the Chartered Engineer/Agency who prepared the Estimates</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtCharteredEngineerName" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">17</td>
                                                    <td align="left" colspan="2">
                                                        <h6 class="text-black font-SemiBold">15 %  Estimate Cost of Infrastructure facilities (Total, Roads, Power, Water)</h6>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">Total</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtEstimateCostSupport15" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">Roads</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtEstimateCostRoadsPowerWater15" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">Power</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtEstimateCostPower15" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">Water</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtEstimateCostWater15" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">18</td>
                                                    <td align="left">Duration of the Project</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtProjectDuration" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">19</td>
                                                    <td align="left">Measures proposed to maintain the infrastructure created and its maintenance cost per annum</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtMeasuresproposed" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">20</td>
                                                    <td align="left">Whether financial assistance availed earlier from any other schemes of the State or Central Govt</td>
                                                    <td align="left">
                                                        <label class="control-label" id="RbtnAssistanceAvailed" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">21</td>
                                                    <td align="left" colspan="2">
                                                        <h6 class="text-black font-bold mb-1" style="font-size: small;">Details of Subsidy Sanctioned / Availed so far with sanction order no & date, if any from Govt. of India or any other Agency</h6>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
