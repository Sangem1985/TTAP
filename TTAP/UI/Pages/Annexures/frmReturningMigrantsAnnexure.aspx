<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmReturningMigrantsAnnexure.aspx.cs" Inherits="TTAP.UI.Pages.Annexures.frmReturningMigrantsAnnexure" %>
                        ...
                        <div class="row-fluid">
                            <div class="widget-box">
                                <div class="widget-title">
                                    ...
                                    <div class="row">
                                        <h3 class="text-black mb-3 col font-SemiBold text-center" runat="server" id="h3heading">Form XIX : Returning Migrant’s Incentive Scheme</h3>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-sm-12 table-responsive">
                                            <table class="table table-bordered title6  w-100 NewEnterprise">
                                                ...
                                                <%--<tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left">
                                                        <label class="control-label" id="txtCapitalInvestment" runat="server"></label>
                                                    </td>
                                                </tr>--%>
                                                <tr>
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left">Scheme: SITP, GOI MSME Cluster Development</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtScheme" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">10</td>
                                                    <td align="left">Percentage of Members as Weavers</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtWeaversPercentage" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">11</td>
                                                    <td align="left">Contribution to investment by beneficiary groups in Rs.</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtContributiontoinvestment" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">12</td>
                                                    <td align="left">Percentage GOI contribution in Capital Investment</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtPercentageGOIContribution" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">13</td>
                                                    <td align="left" colspan="2">
                                                        <h6 class="text-black font-SemiBold">Investments for Setting up Unit (In Rupees)</h6>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left">
                                                        <label class="control-label" id="txtOthers" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left">Current Claim (In Rupees) (Reimbursement 50% of their investment towards infrastructure creation subject to a maximum amount of Rs.2.00 crores)</td>
                                                    <td align="left">
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left" colspan="2">
                                                        <h6 class="text-black font-SemiBold mb-1" style="font-size: small;">Whether any amount claim under skill upgradation of Govt. of India/ State Govt. If yes, the details of amount claimed</h6>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
