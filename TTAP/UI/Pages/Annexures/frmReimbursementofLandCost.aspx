<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmReimbursementofLandCost.aspx.cs" Inherits="TTAP.UI.Pages.Annexures.frmReimbursementofLandCost" %>
...
<head runat="server">
    ...
    <style>
        ...
        /*div#ContentPlaceHolder1_chkLandAllotmentInformation.table-bordered td, .table-bordered th {
            border: 0px solid #c8ccd0 !important;
        }*/
    </style>
                        ...
                        <div class="row-fluid">
                            <div class="widget-box">
                                <div class="widget-title">
                                    ...
                                    <div class="row">
                                        <h3 class="text-black mb-3 col font-SemiBold text-center" runat="server" id="h3heading">Form – XII: Reimbursement of Land Cost</h3>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-sm-12 table-responsive">
                                            <table class="table table-bordered title6  w-100 NewEnterprise">
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left">
                                                        <label class="control-label" runat="server" id="lblTextileType"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left">Whether the Unit is Located in the Textile/ Apparel park Declared by the Govt Of Telangana</td>
                                                    <td align="left">
                                                        <label class="control-label" id="RbtnTexttileLocationTS" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">10</td>
                                                    <td align="left">Category/Definition of the Unit</td>
                                                    <td align="left">
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left" colspan="2">Land Allotment Information</td>

                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">12</td>
                                                    <td align="left" colspan="2">
                                                        <asp:CheckBoxList ID="chkLandAllotmentInformation" Enabled="false" runat="server" CssClass="checkbox" RepeatDirection="Vertical">
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left">Total Plinth Area of Factory Building (In Square Meters)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtTotalPlinthArea" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center">14</td>
                                                    <td align="left">Total Extent Of Land Purchased (In Acres)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtTotalExtentOfLandPurchased" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">Rate Per Acre (In Rs)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtRatePerAcre" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                    <td align="center"></td>
                                                    <td align="left">Total Investment in Land (In Rs)</td>
                                                    <td align="left">
                                                        <label class="control-label" id="txtTotalInvestmentinLand" runat="server"></label>
                                                    </td>
                                                </tr>
                                                <tr class="GridviewScrollC1Item2">
                                                ...
                                                <tr class="GridviewScrollC1Item2">
                                                    ...
                                                    <td align="left">Reimbursement Amount Claimed by The Industry/Enterprise (In Ruppes) (50% Rebate on Land Cost Ascertained By TSIIC Upto Rs 10 Lakks Per Acre. In Case Of Technical Textile Units, an Additional Rebate of 25% With a Cap of Rs 10 Lakhs Per Acre Shall be Extended)</td>
                                                    <td align="left">
