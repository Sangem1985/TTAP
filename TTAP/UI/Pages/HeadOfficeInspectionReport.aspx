                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 table-responsive">
                                            <table class="table table-bordered title6  w-100 NewEnterprise">
                                                <tr>
                                                    <td align="left" style="width: 10%" class="font-SemiBold">Name and Designation of the Inspecting Officer</td>
                                                    <td align="left" style="width: 10%">
                                                        <label class="control-label" id="lblInspectingOfficerName" runat="server"></label>
                                                    </td>
                                                    <td align="left" style="width: 10%" class="font-SemiBold">Inspection Schduled Date</td>
                                                    <td align="left" style="width: 10%">
