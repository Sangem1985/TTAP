...
{
    public partial class RejectedApplicationsDetails : System.Web.UI.Page
    {
        ...
        {
            string Level = "", DistrictId = "", OrderFlag = "D";
            if (Request.QueryString["Level"] != null)
            {
                Level = Request.QueryString["Level"].ToString();
            }
        ...
        public DataSet GetSubmittedIncentiveList(string DistrictId, string UnitName, string OrderFlag)
        {
            ...
            Dsnew = caf.GenericFillDs("USP_GET_DETAILED_REJECTED_APPS", pp);
        ...
        public DataSet GetIncentiveList(string IncentiveID)
        {
            ...
            Dsnew = caf.GenericFillDs("[USP_GET_REJECTED_INCENTIVES_LIST]", pp);

            return Dsnew;
        }
        protected void chkAutoList_CheckedChanged(object sender, EventArgs e)
        {
            BindApplicationData();
        }
        ...
        protected void ExportToExcel()
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=R6-Rejected_Applications.xls");
                Response.Charset = "";
                ...
                using (StringWriter sw = new StringWriter())
                {
                    ...
                    string label1text = "R6. Rejected Applications - Detailed Report";
