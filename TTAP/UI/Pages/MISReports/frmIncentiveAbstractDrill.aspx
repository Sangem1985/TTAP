<%@ Page Title="" Language="C#" MasterPageFile="~/UI/UserMaster.Master" AutoEventWireup="true" CodeBehind="frmIncentiveAbstractDrill.aspx.cs" Inherits="TTAP.UI.Pages.MISReports.frmIncentiveAbstractDrill" %>
                                ...
                                <div class="col-sm-12 table-responsive">
                                    <asp:GridView ID="gvdetailsnew" runat="server" AllowPaging="false" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Uid_NO" ItemStyle-HorizontalAlign="Center" HeaderText="TS-iPASS UID No">
                                                <ItemStyle CssClass="text-left" />
                                            </asp:BoundField>
                                            ...
                                            <asp:TemplateField HeaderText="View Application" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Button ID="btnProcess" runat="server" Text="View" CssClass="btn btn-blue py-1 title7" OnClick="btnProcess_Click"></asp:Button>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:TemplateField>
