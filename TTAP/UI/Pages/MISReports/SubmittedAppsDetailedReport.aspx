<%@ Page Title="" Language="C#" MasterPageFile="~/UI/UserMaster.Master" AutoEventWireup="true" CodeBehind="SubmittedAppsDetailedReport.aspx.cs" Inherits="TTAP.UI.Pages.MISReports.SubmittedAppsDetailedReport" %>
                                    ...
                                    <asp:GridView ID="gvdetailsnew" runat="server" AllowPaging="false" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                           ...
                                           <%-- <asp:BoundField DataField="DistrictName" ItemStyle-HorizontalAlign="Center" HeaderText="District Name">
                                            ...
                                            <asp:BoundField DataField="ScrutinyCompletedDate" ItemStyle-HorizontalAlign="Center" HeaderText="Scrutiny Completed Date">
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:BoundField>
                                            ...
                                            <asp:TemplateField HeaderText="Cost" ControlStyle-CssClass="SetgridWidth" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:GridView ID="gvCosts" CssClass="SetgridWidth" ShowHeader="true"
                                                        runat="server">
                                                    </asp:GridView>
                                                </ItemTemplate>
