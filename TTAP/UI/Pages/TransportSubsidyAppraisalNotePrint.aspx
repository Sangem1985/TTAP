<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransportSubsidyAppraisalNotePrint.aspx.cs" Inherits="TTAP.UI.Pages.TransportSubsidyAppraisalNotePrint" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Transport Subsidy Appraisal Note</title>
    <style>
        .div3 {
        ...
        <div align="center">
            <div align="center" style="text-align: center">
                ...
                <div>
                        ...
                        <tr>
                            <td style="text-align: center; vertical-align: middle">
                                <u><b>
                                  ...
                                  Transport Subsidy to Export Intensive Textile Units Appraisal Note<br />
                    ...
                    <div class="row" runat="server" id="divNewUnit" visible="false">
                        <table style="width: 93%">
                            <tr id="tr1" runat="server" visible="true">
                                <td></td>
                                <td style="padding: 5px; margin: 5px;" class="auto-style57">Total Revenue of the Unit</td>
                                <td style="padding: 5px; margin: 5px;" class="auto-style56">:</td>
                                <td class="auto-style56">
                                    <asp:Label ID="lblRevenueOfUnit" runat="server" Text="[Guideline Value]"
                            ...
                            <tr id="tr2" runat="server" visible="true">
                                ...
                                <td style="padding: 5px; margin: 5px;" class="auto-style57">Total Export Value of the Unit</td>
                                <td style="padding: 5px; margin: 5px;" class="auto-style56">:</td>
                                <td class="auto-style56">
                                    <asp:Label ID="lblExportValueOfUnit" runat="server" Text="[Guideline Value]"
                                        Height="30px" MaxLength="80" Enabled="false" TabIndex="34" Width="150px"></asp:Label>
                                </td>
                                <td style="padding: 5px; margin: 5px;" class="auto-style56">&nbsp;
                                </td>
                    ...
                    <div class="row" runat="server" id="divExpansionUnit" visible="false">
                        <table style="width: 100%">
                            <tr id="tr3" runat="server" visible="true">
                                <td class="auto-style56"></td>
                                <td style="padding: 5px; margin: 5px;" class="auto-style57">Average Revenue(Last Three Years)</td>
                                <td  class="auto-style56">:</td>
                                <td class="auto-style56">
                                    <asp:Label ID="lblAverageRevenue" runat="server" Text="[Guideline Value]"
                                        Height="30px" MaxLength="80" Enabled="false" TabIndex="34" Width="150px"></asp:Label>
                                </td>
                                <td style="padding: 5px; margin: 5px;" class="auto-style56">&nbsp;
                                </td>
                            ...
                            <tr id="tr4" runat="server" visible="true">
                                <td class="auto-style56"></td>
                                <td style="padding: 5px; margin: 5px;" class="auto-style57">Revenue After Expansion</td>
                                <td style="padding: 5px; margin: 5px;" class="auto-style56">:</td>
                                <td class="auto-style56">
                                    <asp:Label ID="lblRevenueAfterExpansion" runat="server" Text="[Guideline Value]"
                                        Height="30px" MaxLength="80" Enabled="false" TabIndex="34" Width="150px"></asp:Label>
                                </td>
                                <td style="padding: 5px; margin: 5px;" class="auto-style56">&nbsp;
                                </td>
                            ...
                            <tr id="tr5" runat="server" visible="true">
                                <td class="auto-style56"></td>
                                <td style="padding: 5px; margin: 5px;" class="auto-style57">Incremental Revenue</td>
                                <td style="padding: 5px; margin: 5px;" class="auto-style56">:</td>
                                <td class="auto-style56">
                                    <asp:Label ID="lblIncrementalRevenue" runat="server" Text="[Guideline Value]"
                                        Height="30px" MaxLength="80" Enabled="false" TabIndex="34" Width="150px"></asp:Label>
                                </td>
                                <td style="padding: 5px; margin: 5px;" class="auto-style56">&nbsp;
                                </td>
                            ...
                            <tr id="tr6" runat="server" visible="true">
                                <td class="auto-style56"></td>
                                <td style="padding: 5px; margin: 5px;" class="auto-style57">Average Fright Charges(Last Three Years)</td>
                                <td style="padding: 5px; margin: 5px;" class="auto-style56">:</td>
                                <td class="auto-style56">
                                    <asp:Label ID="lblAverageFrightCharges" runat="server" Text="[Guideline Value]"
                                        Height="30px" MaxLength="80" Enabled="false" TabIndex="34" Width="150px"></asp:Label>
                                </td>
                                <td style="padding: 5px; margin: 5px;" class="auto-style56">&nbsp;
                                </td>
                            ...
                            <tr id="tr7" runat="server" visible="true">
                                <td class="auto-style56"></td>
                                <td style="padding: 5px; margin: 5px;" class="auto-style57">Total Freight Charges After Expansion</td>
                                <td style="padding: 5px; margin: 5px;" class="auto-style56">:</td>
                                <td class="auto-style56">
                                    <asp:Label ID="lblTotalFreightChargesAfterExp" runat="server" Text="[Guideline Value]"
                                        Height="30px" MaxLength="80" Enabled="false" TabIndex="34" Width="150px"></asp:Label>
                                </td>
                                <td style="padding: 5px; margin: 5px;" class="auto-style56">&nbsp;
                                </td>
