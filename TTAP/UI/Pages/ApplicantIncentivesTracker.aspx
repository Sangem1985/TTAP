<%@ Page Title="" Language="C#" MasterPageFile="~/UI/UserMaster.Master" AutoEventWireup="true" CodeBehind="ApplicantIncentivesTracker.aspx.cs" Inherits="TTAP.UI.Pages.ApplicantIncentivesTracker" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function fn_ChangeSrch() {
            $('#ContentPlaceHolder1_btnReset').click();
            if ($('#ContentPlaceHolder1_rdbSelection_0').is(':checked') == true) {
                $('#ContentPlaceHolder1_txtsearch').attr('placeholder','Enter UID No to Search');
            }
            if ($('#ContentPlaceHolder1_rdbSelection_1').is(':checked') == true) {
                $('#ContentPlaceHolder1_txtsearch').attr('placeholder','Enter Unit Name to Search');
            }
            if ($('#ContentPlaceHolder1_rdbSelection_2').is(':checked') == true) {
                $('#ContentPlaceHolder1_txtsearch').attr('placeholder','Enter Application No to Search');
            }
        }
    </script>
                ...
                <div id="content-header">
                    ...
                    <div class="breadcrumb-bg">
                        <ul class="breadcrumb font-medium title5 container">
                            ...
                            <li class="breadcrumb-item">Application Tracker</li>
                        </ul>
                    </div>
                </div>
                <div class="container mt-4 pb-4" id="Receipt" runat="server">
                    <div class="w-100 px-3 frm-form box-content py-3 font-medium title5">
                        <h5 class="text-blue mt-1 mb-3 font-SemiBold">Applicantion Status Tracker</h5>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:RadioButtonList ID="rdbSelection" Style="margin: 5px 550px 11px 15px;"
                                ...
                                <ContentTemplate>
                                    <table align="center" cellpadding="10" cellspacing="5" style="width: 90%">
                                                ...
                                                <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Application No">
                                                            <ItemTemplate>
                                                                <asp:HyperLink ID="anchortagApplicationNo" runat="server" Text='<%#Eval("ApplicationNo") %>'/>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                        ...
                                        <tr id="tr1" runat="server" visible="false">
                                            <td align="center" style="padding: 5px; margin: 5px; text-align: center;" valign="top">&nbsp;<b> No Records found by your searched Text</b>
                                            </td>
                                        </tr>
                                    </table>
                                </ContentTemplate>
