...
{
    public partial class frmSVCSactionedApplications : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.Redirect("frmDLSVCAllApplicationst.aspx?Cast=" + lblCategory1 + "&MstIncentiveId=" + lblMstIncentiveId + "&SubIncId=" + lblSubIncType +
        ...
        public void getallapprovedSVCno()
        {
            ...
            pp[0].Value = Distid;
            ds = ObjCAFClass.GenericFillDs("USP_GET_LIST_INCENTIVE_SVCSanctionNO", pp);
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            ds = ObjCAFClass.GenericFillDs("USP_GET_ABSTRACT_DLSVC_APPROVED", pp);
