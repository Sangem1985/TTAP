<%@ Page Title="" Language="C#" MasterPageFile="~/UI/UserMaster.Master" AutoEventWireup="true" CodeBehind="frmDLSVCGenerateAgendaList.aspx.cs" Inherits="TTAP.UI.Pages.DLSVC.frmDLSVCGenerateAgendaList" %>
                ...
                <div id="content-header">
                    ...
                    <div class="breadcrumb-bg">
                        <ul class="breadcrumb font-medium title5 container">
                            ...
                            <li class="breadcrumb-item">Generate DL-SVC Agenda</li>
                        </ul>
                    </div>
                </div>
                                ...
                                <div class="widget-content nopadding">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 text-center" id="tblselection" runat="server">
                                            <asp:Button ID="btnGenerateProposedAgenda" CssClass="btn btn-primary m-2" runat="server" Text="Generate Proposed DL-SVC Agenda" OnClick="btnGenerateProposedAgenda_Click" />
