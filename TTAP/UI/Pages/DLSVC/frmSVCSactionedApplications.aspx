<%@ Page Title="" Language="C#" MasterPageFile="~/UI/UserMaster.Master" AutoEventWireup="true" CodeBehind="frmSVCSactionedApplications.aspx.cs" Inherits="TTAP.UI.Pages.DLSVC.frmSVCSactionedApplications" %>
                ...
                <div id="content-header">
                    ...
                    <div class="breadcrumb-bg">
                        <ul class="breadcrumb font-medium title5 container">
                            ...
                            <li class="breadcrumb-item">DL-SVC Sanctioned Incentives</li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="w-100 px-3 frm-form box-content py-3 font-medium title5">
                            <div class="widget-box">
                                <div class="widget-title">
                                    ...
                                    <h5 class="text-blue mb-3 font-SemiBold">List of Cases DL-SVC Sanctioned Incentives</h5>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-3 form-group">
                                            ...
                                            <asp:DropDownList runat="server" ID="ddlworkingstatus" CssClass="form-control" TabIndex="1">
                                                ...
                                                <asp:ListItem Value="1" Text="DL-SVC Approved Applications"></asp:ListItem>
