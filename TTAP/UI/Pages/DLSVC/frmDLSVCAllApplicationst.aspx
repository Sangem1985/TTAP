<%@ Page Title="" Language="C#" MasterPageFile="~/UI/UserMaster.Master" AutoEventWireup="true" CodeBehind="frmDLSVCAllApplicationst.aspx.cs" Inherits="TTAP.UI.Pages.DLSVC.frmDLSVCAllApplicationst" %>
                ...
                <div id="content-header">
                    ...
                    <div class="breadcrumb-bg">
                        <ul class="breadcrumb font-medium title5 container">
                            ...
                            <li class="breadcrumb-item">Generated DL-SVC Agenda</li>
                        </ul>
                    </div>
                </div>
                                ...
                                <div class="widget-content nopadding">
                                        ...
                                        <div class="row col-sm-12">
                                            <div class="col-sm-6 col-md-3 form-group">
                                                ...
                                                <asp:DropDownList runat="server" ID="ddlworkingstatus" CssClass="form-control" TabIndex="1" Enabled="false">
                                                    ...
                                                    <asp:ListItem Value="1" Text="DLC Approved Applications"></asp:ListItem>
                                            ...
                                            <div class="col-sm-6 col-md-3 form-group">
                                                <label runat="server" id="td1">DL-SVC No</label>
                                        ...
                                        <div class="col-sm-12 table-responsive">
                                            <asp:GridView ID="gvdetailsnew" runat="server" AllowPaging="false" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="SLCDLCRecommended_date" ItemStyle-HorizontalAlign="Center" HeaderText="DLO Recommended Date">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="FinalSanctionedAmount" ItemStyle-HorizontalAlign="Center" HeaderText="DL SVC Sanctioned Amount">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="Meeting_No" ItemStyle-HorizontalAlign="Center" HeaderText="DL SVC Meeting No">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="Actual_Meeting_Date" ItemStyle-HorizontalAlign="Center" HeaderText="DL SVC Meeting Date">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 text-center" id="tblselection" runat="server">
                                            <asp:Button ID="btnprint" runat="server" CssClass="btn btn-blue m-2" Text="Print Agenda" OnClientClick="javascript:Panel1()" />
