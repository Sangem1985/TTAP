<%@ Page Title="" Language="C#" MasterPageFile="~/UI/UserMaster.Master" AutoEventWireup="true" CodeBehind="frmDLSVCGeneratedAgendaAbstract.aspx.cs" Inherits="TTAP.UI.Pages.DLSVC.frmDLSVCGeneratedAgendaAbstract" %>
                        ...
                        <div class="w-100 px-3 frm-form box-content py-3 font-medium title5">
                            <div class="widget-box">
                                <div class="widget-title">
                                    ...
                                    <h5 class="text-blue mb-3 font-SemiBold">Generated DL-SVC Agenda</h5>
                                </div>
                                        ...
                                        <div class="col-sm-12 form-group">
                                            <div class="row py-4">
                                                ...
                                                <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                                                    <asp:DropDownList ID="ddlProposedDLCs" runat="server" class="form-control">
                                                        <asp:ListItem Value="0" Text="--Select--"></asp:ListItem>
                                                    </asp:DropDownList>
                                                </div>
                                                <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                                                    <asp:Button ID="btnGetDLClist" CssClass="btn btn-blue py-1 title7 mt-1" runat="server" Text="Get Proposed DLC Agenda" OnClick="btnGetDLClist_Click" />
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <asp:GridView ID="gvdetailsnew" runat="server" AllowPaging="false" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="View">
                                                        <ItemTemplate>
                                                            <asp:Button ID="btnGenerate" Height="25px" CssClass="btn btn-primary" OnClick="Button1_Click" runat="server" Text="View" Width="100px" />
