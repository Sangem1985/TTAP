<%@ Page Title="" Language="C#" MasterPageFile="~/UI/UserMaster.Master" AutoEventWireup="true" CodeBehind="frmDLSVCGeneratedAgendaUpdate.aspx.cs" Inherits="TTAP.UI.Pages.DLSVC.frmDLSVCGeneratedAgendaUpdate" %>
                        ...
                        <div class="w-100 px-3 frm-form box-content py-3 font-medium title5">
                            <div class="widget-box">
                                ...
                                <div class="widget-content nopadding">
                                        ...
                                        <div class="col-sm-12 form-group">
                                            <div class="row py-1">
                                                <div class="col-lg-2 col-md-12 col-sm-12 col-xs-12">
                                                    <label class="control-label" id="Label10" runat="server">Proposed DL-SVC Date </label>
                                                </div>
                                        ...
                                        <div class="col-sm-12 table-responsive">
                                            <asp:GridView ID="gvdetailsnew" runat="server" AllowPaging="false" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="ActualRecommendedAmount" ItemStyle-HorizontalAlign="Center" HeaderText="DLO Recommended Amount">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 text-blue font-SemiBold mb-1">DL-SVC Proceedings to be uploaded</div>
                                        <div class="col-sm-12 table-responsive">
                                            <table class="table table-bordered title6 alternet-table w-100 NewEnterprise">
                                                ...
                                                <tr class="GridviewScrollC1Item" id="trDocrent" runat="server">
                                                    ...
                                                    <td align="left" style="width: 50%">DL-SVC Proceedings</td>
                                                    <td align="left">
