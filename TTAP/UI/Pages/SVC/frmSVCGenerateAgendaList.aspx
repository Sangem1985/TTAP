<%@ Page Title="" Language="C#" MasterPageFile="~/UI/UserMaster.Master" AutoEventWireup="true" CodeBehind="frmSVCGenerateAgendaList.aspx.cs" Inherits="TTAP.UI.Pages.SVC.frmSVCGenerateAgendaList" %>
                                ...
                                <div class="widget-content nopadding">
                                        ...
                                        <div class="col-sm-12 table-responsive">
                                            <asp:GridView ID="gvdetailsnew" runat="server" AllowPaging="false" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="SLCDLCRecommended_date" ItemStyle-HorizontalAlign="Center" HeaderText="JD Recommended Date">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="ActualRecommendedAmount" ItemStyle-HorizontalAlign="Center" HeaderText="JD Recommended Amount">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="PartialRemarks" ItemStyle-HorizontalAlign="Center" HeaderText="Remarks">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    <asp:TemplateField HeaderText="Incentiveid" Visible="false">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:Label ID="lblPartialFlag" Text='<%#Eval("PartialFlag") %>' runat="server" />
                                                            <asp:Label ID="lblTIS" Text='<%#Eval("TIS") %>' runat="server" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 text-center" id="tblselection" runat="server">
                                            <asp:Button ID="btnGenerateProposedAgenda" CssClass="btn btn-primary m-2" runat="server" Text="Generate Proposed SVC Agenda" OnClick="btnGenerateProposedAgenda_Click" />
