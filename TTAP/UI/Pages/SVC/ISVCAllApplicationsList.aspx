<%@ Page Title="" Language="C#" MasterPageFile="~/UI/UserMaster.Master" AutoEventWireup="true" CodeBehind="ISVCAllApplicationsList.aspx.cs" Inherits="TTAP.UI.Pages.SVC.ISVCAllApplicationsList" %>
                ...
                <div id="content-header">
                    ...
                    <div class="breadcrumb-bg">
                        <ul class="breadcrumb font-medium title5 container">
                            ...
                            <li class="breadcrumb-item">Generated SVC Agenda</li>
                        </ul>
                    </div>
                </div>
                                ...
                                <div class="widget-content nopadding">
                                    <div class="row" id="divPrint" runat="server">
                                        ...
                                        <div class="row col-sm-12">
                                            ...
                                            <div class="col-sm-6 col-md-3 form-group">
                                                <label runat="server" id="td1">SVC No</label>
                                        ...
                                        <div class="col-sm-12 table-responsive">
                                            <asp:GridView ID="gvdetailsnew" runat="server" AllowPaging="false" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                   ...
                                                   <%-- <asp:BoundField DataField="SLCDLCRecommended_date" ItemStyle-HorizontalAlign="Center" HeaderText="Recommended Date">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>--%>
                                                    <asp:BoundField DataField="FinalSanctionedAmount" ItemStyle-HorizontalAlign="Center" HeaderText="SVC Sanctioned Amount">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="Meeting_No" ItemStyle-HorizontalAlign="Center" HeaderText="SVC Meeting No">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="Actual_Meeting_Date" ItemStyle-HorizontalAlign="Center" HeaderText="SVC Meeting Date">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
