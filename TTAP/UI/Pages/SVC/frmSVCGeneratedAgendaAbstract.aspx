<%@ Page Title="" Language="C#" MasterPageFile="~/UI/UserMaster.Master" AutoEventWireup="true" CodeBehind="frmSVCGeneratedAgendaAbstract.aspx.cs" Inherits="TTAP.UI.Pages.SVC.frmSVCGeneratedAgendaAbstract" %>
                        ...
                        <div class="w-100 px-3 frm-form box-content py-3 font-medium title5">
                            <div class="widget-box">
                                <div class="widget-title">
                                    ...
                                    <h5 class="text-blue mb-3 font-SemiBold">Generated SVC Agenda</h5>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 form-group">
                                            <div class="row py-4">
                                                ...
                                                <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                                                    <asp:Button ID="btnGetDLClist" CssClass="btn btn-blue py-1 title7 mt-1" runat="server" Text="Get Proposed SVC Agenda" OnClick="btnGetDLClist_Click" />
                                                </div>
                                            </div>
                                        </div>
