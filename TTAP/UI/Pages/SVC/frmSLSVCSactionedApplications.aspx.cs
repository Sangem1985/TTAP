...
{
    public partial class frmSLSVCSactionedApplications : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // ReleasePendingViewDIPCOnline.aspx
                Response.Redirect("frmSVCAllApplicationst.aspx?Cast=" + lblCategory1 + "&MstIncentiveId=" + lblMstIncentiveId + "&SubIncId=" + lblSubIncType +
                "&APPMODE=" + ddlApplicationMode.SelectedValue + "&APPSTATUS=" + ddlworkingstatus.SelectedValue + "&TIMELINES=" + DropDownList1.SelectedValue +
                "&DIPCNumber=" + ddlDIPCno.SelectedValue + "&ALLAPPSTATUS=" + AllApplicationstatus + "&PartialSanction=" + PartialSanction);
            }
            catch (Exception ex)
            {
        ...
        public void getallapprovedSVCno()
        {
            ...
            pp[0].Value = Distid;
            pp[1].Value = PartialSanction;
            ds = ObjCAFClass.GenericFillDs("USP_GET_LIST_INCENTIVE_SL_SVCSanctionNO", pp);
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            ds = ObjCAFClass.GenericFillDs("USP_GET_ABSTRACT_SVC_APPROVED", pp);
