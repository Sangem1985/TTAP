...
{
    public partial class frmSVCGenerateAgendaList : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                string distid = "";string PartialSanction = "N";
                ...
                ds = ObjCAFClass.GetSVCYetGenerateAgendaList(Cast, Investmentid, distid, Status, PartialSanction);
        ...
        protected void btnGenerateProposedAgenda_Click(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow gvrow in gvdetailsnew.Rows)
            {
                ...
                if (chkcheck.Checked == true)
                {
                    ...
                    objApplicationStatus.PartialSanction = ((Label)gvrow.FindControl("lblPartialFlag")).Text.ToString();
                    objApplicationStatus.TISId = ((Label)gvrow.FindControl("lblTIS")).Text.ToString();
                    ...
                    objApplicationStatus.TransType = "SVCAGENDA";
            ...
            if (valid == "1")
            {
                ...
                string message = "alert('Proposed SVC Agenda Generated Successfully')";
                ScriptManager.RegisterClientScriptBlock((sender as Control), this.GetType(), "alert", message, true);
