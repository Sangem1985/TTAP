<%@ Page Title="" Language="C#" MasterPageFile="~/UI/UserMaster.Master" AutoEventWireup="true" CodeBehind="frmSVCGeneratedAgendaUpdate.aspx.cs" Inherits="TTAP.UI.Pages.SVC.frmSVCGeneratedAgendaUpdate" %>
                        ...
                        <div class="w-100 px-3 frm-form box-content py-3 font-medium title5">
                            <div class="widget-box">
                                ...
                                <div class="widget-content nopadding">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 text-blue font-SemiBold mb-1">SVC Proceedings to be uploaded</div>
                                        <div class="col-sm-12 table-responsive">
                                            <table class="table table-bordered title6 alternet-table w-100 NewEnterprise">
                                                ...
                                                <tr class="GridviewScrollC1Item" id="trDocrent" runat="server">
                                                    ...
                                                    <td align="left" style="width: 50%">SVC Proceedings</td>
                                                    <td align="left">
