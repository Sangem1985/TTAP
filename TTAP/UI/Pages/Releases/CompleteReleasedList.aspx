<%@ Page Title="" Language="C#" MasterPageFile="~/UI/UserMaster.Master" AutoEventWireup="true" CodeBehind="CompleteReleasedList.aspx.cs" Inherits="TTAP.UI.Pages.Releases.CompleteReleasedList" %>
                ...
                <div id="content-header">
                    ...
                    <div class="breadcrumb-bg">
                        <ul class="breadcrumb font-medium title5 container">
                            ...
                            <li class="breadcrumb-item">Compplete Released Incentives</li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="w-100 px-3 frm-form box-content py-3 font-medium title5">
                            <div class="widget-box">
                                <div class="widget-title">
                                    ...
                                    <h5 class="text-blue mb-3 font-SemiBold">List of Compplete Released Incentives</h5>
                                </div>
                                        ...
                                        <div class="col-sm-12 table-responsive">
                                            <asp:GridView ID="gvdetailsnew" runat="server" AllowPaging="false" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="FinalSanctionedAmount" ItemStyle-HorizontalAlign="Center" HeaderText="Sanctioned & Released Amount">
                                                        <ItemStyle CssClass="text-left" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="Released_Date" ItemStyle-HorizontalAlign="Center" HeaderText="Released Date">
                                                        <ItemStyle CssClass="text-left" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="GONo" ItemStyle-HorizontalAlign="Center" HeaderText="GO No">
                                                        <ItemStyle CssClass="text-left" />
                                                    </asp:BoundField>
