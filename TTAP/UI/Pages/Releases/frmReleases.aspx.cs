...
{
    public partial class frmReleases : System.Web.UI.Page
    {
        ...
        protected void ddlgos_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Label lblRecommendedAmount = ((Label)gvdetailsnew.Rows[indexing].FindControl("lblRecommendedAmount"));
        ...
        protected void btnGenerate_Click(object sender, EventArgs e)
        {
            ...
            string IncentiveID = lblIncentiveID.Text;
            string GOID = "";

            Response.Redirect("frmReleasesList.aspx?Stage=" + Stage + "&ApplicationMode=" + ApplicationMode +
                "&Category=" + Category + "&GOID=" + GOID + "&SubIncentiveID=" + SubIncentiveID + "&IncentiveID=" + IncentiveID);
