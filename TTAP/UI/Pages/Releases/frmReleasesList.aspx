<%@ Page Title="" Language="C#" MasterPageFile="~/UI/UserMaster.Master" AutoEventWireup="true"
    CodeBehind="frmReleasesList.aspx.cs" Inherits="TTAP.UI.Pages.Releases.frmReleasesList" %>
                                ...
                                <div class="widget-content nopadding">
                                        ...
                                        <div class="col-sm-12 table-responsive">
                                            <asp:GridView ID="gvdetailsnew" runat="server" AllowPaging="false" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="AllotedAmount" Visible="false" HeaderText="Released Amount">
                                                        <ItemStyle CssClass="text-left" />
                                                    </asp:BoundField>
                                    ...
                                    <div class="row pt-4" id="trbalance" runat="server">
                                        ...
                                        <div class="col-sm-6 form-group">
                                            ...
                                            <label class="form-control font-bold  text-success" id="lblbalanceamount" runat="server"></label>
                                        </div>
