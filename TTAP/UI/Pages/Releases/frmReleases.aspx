<%@ Page Title="" Language="C#" MasterPageFile="~/UI/UserMaster.Master" AutoEventWireup="true" CodeBehind="frmReleases.aspx.cs" Inherits="TTAP.UI.Pages.Releases.frmReleases" %>
                                            ...
                                            <asp:GridView ID="gvdetailsnew" runat="server" AllowPaging="false" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Sanctioned Amount">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblRecommendedAmount" Text='<%#Eval("FinalSanctionedAmount") %>' runat="server"></asp:Label>
                                                        </ItemTemplate>
