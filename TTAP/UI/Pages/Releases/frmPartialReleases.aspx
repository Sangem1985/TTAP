<%@ Page Title="" Language="C#" MasterPageFile="~/UI/UserMaster.Master" AutoEventWireup="true" CodeBehind="frmPartialReleases.aspx.cs" Inherits="TTAP.UI.Pages.Releases.frmPartialReleases" %>
                                            ...
                                            <asp:GridView ID="gvdetailsnew" runat="server" AllowPaging="false" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Pending Release Amount">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblPendingReleaseAmount" Text='<%#Eval("PendingAmount") %>' runat="server"></asp:Label>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Left" />
                                                    </asp:TemplateField>
                                                   <%-- <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="G.O">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Action">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:Label ID="lblIncentiveID" runat="server" Visible="false" Text='<%#Eval("IncentiveID") %>'></asp:Label>
