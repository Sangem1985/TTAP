<%@ Page Title="" Language="C#" MasterPageFile="~/UI/UserMaster.Master" AutoEventWireup="true" CodeBehind="frmReleasedApplications.aspx.cs" Inherits="TTAP.UI.Pages.Releases.frmReleasedApplications" %>
                        ...
                        <div class="w-100 px-3 frm-form box-content py-3 font-medium title5">
                            <div class="widget-box">
                                <div class="widget-title">
                                    ...
                                    <h5 class="text-blue mb-3 font-SemiBold">List of Cases Released Incentives</h5>
                                </div>
                                <div class="widget-content nopadding">
                                    <div runat="server" visible="false" class="row">
                                        ...
                                        <div runat="server" visible="false" class="col-sm-6 col-md-3 form-group">
                                        ...
                                        <div class="col-sm-12 table-responsive">
                                            <asp:GridView ID="gvdetailsnew" runat="server" AllowPaging="false" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Application Number">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Sanctioned Amount">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblFinalSanctionedAmount" Text='<%#Eval("FinalSanctionedAmount") %>' runat="server"></asp:Label>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Left" />
                                                    </asp:TemplateField>
                                                     <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Released Amount">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblRELEASEDAMOUNT" Text='<%#Eval("RELEASEDAMOUNT") %>' runat="server"></asp:Label>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Left" />
                                                    </asp:TemplateField>
                                                     <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Released Date">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblRELEASEDDATE" Text='<%#Eval("RELEASEDDATE") %>' runat="server"></asp:Label>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Left" />
                                                    </asp:TemplateField>
                                                     <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Release Proceeding No">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblPROCEEDINGNUMBER" Text='<%#Eval("PROCEEDINGNUMBER") %>' runat="server"></asp:Label>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Left" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="GO No">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblGONumber" Text='<%#Eval("GONumber") %>' runat="server"></asp:Label>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Left" />
                                                    </asp:TemplateField>
                                                     <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="SLC or DLCNumer">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblSLCDLCNumer" Text='<%#Eval("SLCDLCNumer") %>' runat="server"></asp:Label>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Left" />
                                                    </asp:TemplateField>
