...
namespace DB
{
    ...
    public class DB
    {
        ...
        public void OpenConnection()
        {
            if (cnn.State == 0)
            {
                cnn.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["TTAPDB"].ConnectionString; //@"Data Source=.;Initial Catalog=citizencharter;USER id=sa;password=sa";
                cnn.Open();
            }
        }
