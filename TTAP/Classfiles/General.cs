...
namespace TTAP.Classfiles
{
    public class General
    {
        ...
        public int InsertWorkSheetFile(string IncId, string SubIncId, string FileNm, string FilePath, string FileDescription, string DocUploadedUserType, string IsDigiLocker, string EnclTpeesign, string Createdby, string QueryId, string Type)
        {
            int valid = 0;
            try
            {
